...
Route::get('output_lab1_gb_longgrain_index', [MasterlabController::class, 'output_lab1_gb_longgrain_index'])->name('output_lab1_gb_longgrain_index');
Route::get('output_lab1_gb_pandan_wangi_index', [MasterlabController::class, 'output_lab1_gb_pandan_wangi_index'])->name('output_lab1_gb_pandan_wangi_index');
Route::get('output_lab1_gb_ketan_putih_index', [MasterlabController::class, 'output_lab1_gb_ketan_putih_index'])->name('output_lab1_gb_ketan_putih_index');
Route::get('output_lab1_qc_pk_index', [MasterlabController::class, 'output_lab1_qc_pk_index'])->name('output_lab1_qc_pk_index');
Route::get('/output_lab1_gb_longgrain_approved_index', [MasterlabController::class, 'output_lab1_gb_longgrain_approved_index'])->name('output_lab1_gb_longgrain_approved_index');
Route::get('/output_lab1_gb_longgrain_approvedtolak_index', [MasterlabController::class, 'output_lab1_gb_longgrain_approvedtolak_index'])->name('output_lab1_gb_longgrain_approvedtolak_index');
Route::get('/count_outputlab1_gb', [MasterlabController::class, 'count_outputlab1_gb'])->name('count_outputlab1_gb');

// Hasil Lab 2 Index
Route::get('output_lab2_gb_ciherang_index', [MasterlabController::class, 'output_lab2_gb_ciherang_index'])->name('output_lab2_gb_ciherang_index');
Route::get('output_lab2_gb_longgrain_index', [MasterlabController::class, 'output_lab2_gb_longgrain_index'])->name('output_lab2_gb_longgrain_index');
Route::get('output_lab2_gb_pandan_wangi_index', [MasterlabController::class, 'output_lab2_gb_pandan_wangi_index'])->name('output_lab2_gb_pandan_wangi_index');
Route::get('output_lab2_gb_ketan_putih_index', [MasterlabController::class, 'output_lab2_gb_ketan_putih_index'])->name('output_lab2_gb_ketan_putih_index');
