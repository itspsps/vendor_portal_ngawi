...
<head>
    ...
    @include('dashboard.admin_spvap.layout.css')
    @yield('css')
    <style>
                        ...
                        <div class="kt-header__topbar-item dropdown">
										...
										<form>
											<div class="tab-content">
                                                ...
                                                <div class="text-center">
                                                    <a href="{{route('ap.spv.get_notif_spvap_all')}}"><b>Baca Selengkapnya</b> <i class="flaticon2-right-arrow"></i></a>
                                                </div>
												</div>
											</div>
										</form>
                            ...
                            <div class="kt-header__topbar-item kt-header__topbar-item--user">
                                <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                                    <span class="kt-header__topbar-welcome kt-visible-desktop" style="color: white;">{{Auth::guard('spvap')->user()->name_spv_ap}} <i class="fa fa-user-circle"></i></span>
                                </div>
                                <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">

                                    <!--begin: Navigation -->
                                    <div class="kt-notification">
                                        <a href="{{route('ap.spv.account_spvap')}}" class="kt-notification__item">
                                        ...
                                        <form id="logout-form" action="{{ route('ap.spv.logout') }}" method="POST" style="display: none;">
                                            {{ csrf_field() }}
                                        </form>
                                    </div>
                ...
                <div class="kt-body kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-grid--stretch" id="kt_body">
                    <div class="kt-container  kt-container--fluid  kt-grid kt-grid--ver">
                        ...
                        <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
                            ...
                            @include('dashboard.admin_spvap.layout.menu')
...
<script>
    function getnotif() {
        $.ajax({
            type: "GET",
            url: "{{route('ap.spv.get_notifikasispvap')}}",
    ...
    function newnotif() {
        $.ajax({
            type: "GET",
            url: "{{route('ap.spv.new_notifikasispvap')}}",
            success: function(data) {
                var notif = JSON.parse(data);
                // console.log(data);
                var panjang = notif.length;
    ...
    function getcount_notif_menuall() {
        $.ajax({
            type: "GET",
            url: "{{route('ap.spv.getcount_notif_menuall')}}",
            success: function(data) {
                // console.log(data);
                $("#count_approve_pembelian").empty();
                $("#count_approve_revisi").empty();
                $("#count_approve_pembelian").html(data.count_approve_pembelian);
                $("#count_approve_revisi").html(data.count_approve_revisi);
            }
        });
    }
    setInterval(getnotif, 2000);
    setInterval(getcount_notif_menuall, 2000);
    setInterval(newnotif, 2000);
</script>
</html>