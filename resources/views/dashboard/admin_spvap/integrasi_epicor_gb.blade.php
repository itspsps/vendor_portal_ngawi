        ...
        <div class="col-xl-12 col-lg-12 col-md-12 order-lg-1 order-xl-1">
            <div class="kt-portlet kt-portlet--mobile">
                ...
                <form class="kt-form" action="javascript:void(0)" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('POST') }}
                    <div style="margin-left: 10px;" class="input-daterange">
                        <h5>Filter PO </h5>
                        <div class="row">
                            <div class="col-md-4">
                                <input type="text" value="" name="from_date" id="from_date" class="form-control" placeholder="From Date" readonly />
                            </div>
                            <div class="col-md-4">
                                <input type="text" value="" name="to_date" id="to_date" class="form-control" placeholder="To Date" readonly />
                            </div>
                            <div class="col-md-4">
                ...
                <div class="kt-portlet__body">
                    <ul class="nav nav-pills" role="tablist">
                        ...
                        <li class="nav-item mt-3">
                            <a id="notif_swal_diterimaepicor" class="nav-link" data-toggle="tab" role="tab" href="#m_tabs_3_2"><i class="la la-database"></i>DITERIMA&nbsp;EPICOR</a>
                        </li>
                    </ul>
    ...
    $(document).ready(function() {
        ...
        function load_data(from_date = '', to_date = '') {
            var table = $('#datatable').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{route('ap.spv.integrasi_epicor_gb_index')}}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table1 = $('#datatable1').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{route('ap.spv.integrasi_epicor_gb1_index')}}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
    ...
    $(function() {
                    ...
                    if (result.value) {
                        Swal.fire({
                            ...
                            onBeforeOpen: () => {
                                Swal.showLoading()
                                $.ajax({
                                    url: "{{ route('ap.spv.kirim_epicor_gb_all')}}",
                                    method: "get",
                                    data: {
        ...
        $('#btn_export_kirimepicor').click(function() {
            ...
            $.ajax({
                ...
                url: "{{route('ap.spv.download_data_faktur_pemebelian_aol')}}",
                type: "POST",
                cache: false,
                xhrFields: {
                    responseType: 'blob'
                ...
                success: function(data, status, xhr) {
                    ...
                    link.download = `DATA PESANAN PEMBELIAN GABAH BASAH NGAWI(` + l + ` ` + n + `).xlsx`;
                    link.click();
        ...
        $('#btn_export_terimaepicor').click(function() {
            ...
            $.ajax({
                ...
                url: "{{route('ap.spv.download_data_faktur_pemebelian_aol1')}}",
                type: "POST",
                cache: false,
                xhrFields: {
                    responseType: 'blob'
                ...
                success: function(data, status, xhr) {
                    ...
                    var link = document.createElement('a');
                    link.href = window.URL.createObjectURL(data);
                    link.download = `DATA PESANAN PEMBELIAN GABAH BASAH (EPICOR) NGAWI(` + l + ` ` + n + `).xlsx`;
                    link.click();
