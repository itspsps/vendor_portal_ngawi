@extends('dashboard.admin_qc_bongkar.layout.auth')
@section('title')
            ...
            <div id="sign" class="col-xs-12 col-md-8 offset-md-2 card shadow-lg" style="background-color:#9F187C">
                <div class="row p-2">
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <form class="register-form" id="login-form" action="{{route('qc.bongkar.check')}}" method="post">
                            @if (Session::get('fail'))
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="password" class="form-control" id="password" placeholder="Password" aria-label="Username" aria-describedby="basic-addon1" name="password" @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                                @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group">
                                <input type="checkbox" onclick="show_password()" name="remember-me" id="remember-me" class="agree-term" />
                                <label for="remember-me" class="label-agree-term" style="color:white;"> Tampilkan Password</label>
                            </div>
                            <div class="form-group">
