                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <div class="">
                                    ...
                                    <select id="lokasi_bongkar" required name="lokasi_bongkar" placeholder="" type="text" class="form-control m-input">
                                        <option value="">Pilih Lokasi Bongkar</option>
    ...
    $(document).ready(function() {
        ...
        function load_data(from_date = '', to_date = '') {
            var table = $('#data_longgrain').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('qc.bongkar.data_revisi_gb_longgrain_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table2 = $('#data_pw').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('qc.bongkar.data_revisi_gb_pandan_wangi_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table3 = $('#data_kp').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('qc.bongkar.data_revisi_gb_ketan_putih_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
                        ...
                        Swal.fire({
                            ...
                            onBeforeOpen: () => {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{ route('qc.bongkar.update_dtm')}}",
                                    type: "POST",
                                    dataType: 'json',
        ...
        $(document).on('click', '.to_revisibongkar', function() {
            ...
            var url = "{{ route('qc.bongkar.show_revisi_gb') }}" + "/" + id;
            $.ajax({
                type: "GET",
                url: url,
                success: function(response) {
                    ...
                    $('#lokasi_bongkar').val(parsed.tempat_bongkar);
                }
            });
        });
    });
