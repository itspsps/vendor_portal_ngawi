                    ...
                    <div class="col-12">
                        <div class="row pt-5 pb-5">
                            <div class="col-xl-3 col-sm-3 col-3">
                                <a style="text-align: center;" id="btn_lelang" href="{{ route('user.new_daftar_lelang') }}">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.notif_lelang > 0) {
                    $(".notif_lelang").empty();
                    $(".notif_lelang").append('<h6><span class="badge bg-success text_notif" style="color: rgb(224, 240, 229);">New</span></h6>');
                } else {
                    $(".notif_lelang").empty();
                }
            }
