...
<div class="home_section_bg mb-3" style="box-shadow: 3px 3px 20px; background: rgb(255, 255, 255);background-size: cover; height: 100%; border-radius: 20px;">
    ...
    <div class="container py-5 px-lg-5">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <h5 class="fw-medium mb-5"><b>DAFTAR TRANSAKSI</b></h5>
        </div>
        <div class="row g-4">
            @if($data_pengajuan=='[]' && $data_transaksi=='[]')
            <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.1s">
                <div class="position-relative bg-light rounded pt-5 pb-4 px-4">
                    <div class="d-inline-flex align-items-center justify-content-center bg-primary-gradient rounded-circle position-absolute top-0 start-50 translate-middle shadow" style="width: 60px; height: 60px;">
                        <img src="{{asset('assets_user/assets/img/logo/icon_sps_white1.png')}}" class="rounded-circle" alt="" width="95%">
                    </div>
                ...
                <div class="position-relative bg-light rounded pt-5 pb-4 px-4">
                    ...
                    <dl class="dl-horizontal row" style="font-size: smaller;">
                        ...
                        <dd class="col-7" style="font-weight: bold;">
                            ...
                            <a href="{{url('user/cetak_po',$data->id_data_po)}}" target="_blank" onclick="return false;" name="" title="Cetak PO" class=" btn btn-sm btn-primary">
                                <i class="fa fa-print" style="color:white;"> Cetak PO </i>
                            </a>
                            <a href="{{url('user/scan_po',$data->id_data_po)}}" target="_blank" onclick="return false;" name="" title="Scan PO" class=" btn btn-sm btn-info">
                                <i class="fa fa-qrcode" style="color:white;"> Scan PO </i>
                            </a>
                            @else
                            <a href="{{url('user/cetak_po',$data->id_data_po)}}" name="" title="Cetak PO" class=" btn btn-sm btn-primary">
                                <i class="fa fa-print" style="color:white;"> Cetak PO </i>
                            </a>
                            <a href="{{url('user/scan_po',$data->id_data_po)}}" target="_blank" name="" title="Scan PO" class=" btn btn-sm btn-danger">
                                <i class="fa fa-qrcode" style="color:white;"> Scan PO </i>
                            </a>
                            @endif
                        </dd>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title fs-5" id="exampleModalLabel">Lihat PO</h6>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="text-center">
                                    <h6 style="text-align: center">KODE PO:</h6>
                                    <h4 id="view_kode_po"></h4>
                                </div>
                            </div>
                        </div>
                    </div>
