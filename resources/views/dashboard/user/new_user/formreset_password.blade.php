...
<div class="home_section_bg" style="box-shadow: 3px 3px 20px; background: rgb(255, 255, 255);background-size: cover; height: 100%; border-radius: 20px;">
    ...
    <div class="product_area deals_product">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <div class="wow fadeInUp" data-wow-delay="0.1s">
                <form id="form_sendotp" action="javascript:void(0);" method="post">
                    @csrf
                    <div class="wow fadeInUp" data-wow-delay="0.1s">
                        <div class="row g-3 p-4">
                            <div class="position-relative w-100 mt-3">
                                <input type="hidden" name="id_kategori" id="id_kategori" value="{{$kategori}}">
                                @if($kategori==1)
                                <input class="form-control border-1 rounded-pill w-100 ps-4 pe-5" type="text" id="nomor_hp" name="nomor_hp" placeholder="Nomor HP" style="height: 40px;">
                                ...
                                @else
                                <input class="form-control border-1 rounded-pill w-100 ps-4 pe-5" type="text" id="email" name="email" placeholder="Email" style="height: 40px;">
                                <button type="button" class="btn shadow-none position-absolute top-0 end-0 mt-1 me-2"><i class="fa fa-envelope fs-4" style="color: rgb(139, 128, 224);"></i></button>
                                @endif
                            </div>
                            <div class="login_submit mt-5 wow fadeInUp" data-wow-delay="0.1s">
                                <button type="button" class="btn btn-sm btn-block btn-rounded-circle ml-0 text-white" style="background-color: rgb(110, 97, 209); width: 100%;" data-bs-toggle="offcanvas" data-bs-target="#konfirmasiotp" aria-controls="konfirmasiotp">Kirim Kode (OTP)</button>
    ...
    <div class="offcanvas offcanvas-bottom" style="box-shadow: 3px 3px 20px; border-radius: 20px 20px 0px 0px; height: max-content;" tabindex="-1" id="konfirmasiotp" aria-labelledby="offcanvasBottomLabel">
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasBottomLabel">Konfirmasi Kirim OTP</h5>
        ...
        <div class="offcanvas-body small">
            <div class="text-center mb-4">
                ...
                <br>
                <button id="btn_send_otp" class="btn btn-sm btn-secondary" style="background-color: rgb(110, 97, 209); color: white;">Ya</button>
                <button class="btn btn-sm btn-danger" style="background-color: rgb(191, 49, 13); color: white;" aria-label="Close" data-bs-dismiss="offcanvas">Tidak</button>
            </div>
        </div>
    </div>
