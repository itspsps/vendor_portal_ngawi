    ...
    <div class="product_area deals_product">
        ...
        <div class="container">
            <div class="col-lg-12">
                ...
                <a id="btn_lelang_detail" href="{{url('user/new_lelang_detail/'.$site_ngawi_longgrain->id_bid)}}">
                ...
                <br>
                <br>
                <a id="btn_lelang_detail" href="{{url('user/new_lelang_detail/'.$site_ngawi_pandanwangi->id_bid)}}">
                    <div class="card wow fadeInUp" data-wow-delay="0.1s" style="box-shadow: rgba(50, 50, 93, 0.25) 0px 13px 27px -5px, rgba(0, 0, 0, 0.3) 0px 8px 16px -8px;border-radius: 15px; padding: 10;">
