...
background: linear-gradient(180deg, rgba(178,172,226,1) 7%, rgba(237,236,244,1) 100%);background-size: cover;  height: 100%; border-radius: 30px; margin-top: 10%;">
    <div class="product_area deals_product">
        ...
        <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.1s">
            <div class="position-relative bg-light rounded pt-1 pb-4 px-4">
                ...
                <h5 class="mt-2 mb-3">Tidak Ada Lelang</h5>
            </div>
        </div>
    </div>
    @else
                ...
                <article class="single_product">
                    <figure>
                        ...
                        <div class="product_thumb">
                            <a class="primary_img" id="btn_lelang_detail" href="{{url('user/lelang_detail/'.$site_ngawi_longgrain->id_bid)}}"><img src="{{asset('img_gabah.png')}}" alt="" style="height: 100%;"></a>
                            <a class="secondary_img" id="btn_lelang_detail" href="{{url('user/lelang_detail/'.$site_ngawi_longgrain->id_bid)}}"><img src="{{asset('img_gabah.png')}}" alt="" style="height: 100%;"></a>
                        ...
                        <div class="product_content">
                            <div class="product_content_inner">
                                ...
                                <div class="countdown_text">
                                    <p style="font-weight: bold"><span>{{$site_ngawi_longgrain->description_bid}}</span></p>
                                </div>
