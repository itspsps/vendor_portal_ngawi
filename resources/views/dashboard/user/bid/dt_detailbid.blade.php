...
<div class="product_page_bg" style="background: rgb(178,172,226);
background: linear-gradient(180deg, rgba(178,172,226,1) 7%, rgba(237,236,244,1) 100%);background-size: cover;  height: max-content; border-radius: 30px; margin-top: 10%;">
    ...
    <div class="container">
        <div class="product_details_wrapper mb-55" style="border-radius: 10px;">
            ...
            <div class="product_details">
                <div class="row">
                    <div class="col-lg-5 col-md-6">
                        <div class="product-details-tab">
                            <div id="img-1" class="zoomWrapper single-zoom">
                                <a href="/">
                                    <img id="zoom1" src="{{asset('img_gabah.png')}}" data-zoom-image="{{asset('img_gabah.png')}}" alt="big-1">
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    @if (($data->batas_bid) > date('Y-m-d H:i:s'))
                    <div class="product_variant quantity">
                        <button id="btn_save_lelang" class="button" type="button">Ikuti Lelang</button>
                    </div>
                    @else
                    <div class="product_variant quantity">
                        <button id="btn_lelangberakhir" class="button" type="button" class="btn btn-primary">
