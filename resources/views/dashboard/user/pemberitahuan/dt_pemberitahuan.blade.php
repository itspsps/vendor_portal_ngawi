                                        ...
                                        <div class="d-flex align-items-start">
                                            <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                ...
                                                <a href="javascript:void(0);" class="nav-link list-group-item list-group-item-action border-0" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">
                                                    ...
                                                    <div class="d-flex align-items-start">
                                                        <img src="{{asset('assets_user/assets/img/logo/sps_logo_new.png')}}" class="rounded-circle mr-1" alt="Vanessa Tucker" width="40" height="40">
                                    ...
                                    <div class="col-12 col-lg-7 col-xl-9">
                                        <div class="py-2 px-4 border-bottom d-none d-lg-block">
                                            <div class="d-flex align-items-center py-1">
                                                <div class="position-relative">
                                                    <img src="{{asset('assets_user/assets/img/logo/sps_logo_new.png')}}" class="rounded-circle mr-1" alt="Sharon Lessman" width="40" height="40">
                                                </div>
                                                    ...
                                                    <ul role="tablist" class="nav flex-column dashboard-list">
                                                        ...
                                                        <li>
                                                            <a href="#notif{{ $data->id_broadcast }}" data-toggle="tab" class="nav-link {{ $firsttabs == $data->id_broadcast ? 'active' : '' }}">
                                                                <img src="{{asset('assets_user/assets/img/logo/sps_logo_new.png')}}" class="rounded-circle mr-1" alt="Sharon Lessman" width="50" height="50">
