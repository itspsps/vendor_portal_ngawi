...
<script>
    ...
    $("document").ready(function() {
        ...
        $('#content-notif').html('Mohon Masukkan Email Atau Username Dan Password Dengan Benar');
        ...
        bsOffcanvas.show();
        @elseif(Session::has('non_active'))
        var offcanvasElement = document.getElementById('notif');
        $('#content-notif').html('Akun Anda Tidak Aktif');
        var bsOffcanvas = new bootstrap.Offcanvas(offcanvasElement);
        ...
        bsOffcanvas.show();
        @elseif(Session::has('proses_validasi'))
        var offcanvasElement = document.getElementById('notif');
        $('#content-notif').html('Akun Anda Proses Validasi');
        var bsOffcanvas = new bootstrap.Offcanvas(offcanvasElement);
        ...
        var offcanvasElement = document.getElementById('notif');
        $('#content-notif').html('Logout Sukses');
        var bsOffcanvas = new bootstrap.Offcanvas(offcanvasElement);
