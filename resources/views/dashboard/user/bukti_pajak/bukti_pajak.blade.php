...
<div class="home_section_bg mb-3" style="box-shadow: 3px 3px 20px; background: rgb(255, 255, 255);background-size: cover; height: 100%; border-radius: 20px;">
    ...
    <div class="container py-5 px-lg-5">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <h5 class="fw-medium mb-5"><b>BUKTI POTONG PAJAK</b></h5>
        </div>
        <div class="row g-4">
            @if($broadcaster=='[]')
            <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.1s">
                <div class="position-relative bg-light rounded pt-5 pb-4 px-4">
                    <div class="d-inline-flex align-items-center justify-content-center bg-primary-gradient rounded-circle position-absolute top-0 start-50 translate-middle shadow" style="width:70px; height:70px;">
                        <i class="bi bi-file-earmark-pdf text-white" style="font-size: 36px;"></i>
                    </div>
                    <h5 class="mt-4 mb-3">Tidak Ada Bukti Potong Pajak</h5>
                </div>
            </div>
            @else
                        ...
                        <div class="col-12">
                            <div class="position-relative">
                                <div class="flex-shrink-1 bg-light rounded py-2 px-3">
                                    <h6 class="mb-3 text-center"><b>{{$data->judul_potong_pajak}}</b></h6>
                                    <p>
                                        {{$data->keterangan_potong_pajak}}
                                    </p>
                                    <img src="{{asset('pdf.png')}}" alt="FILE" style="width: 90px;">
                                    <br>
                                    <a href="https://ngawi.suryapangansemesta.store/public/dokumen/potong_pajak/{{$data->file_potong_pajak}}" type="button" class="btn btn-sm btn-info"> DOWNLOAD</a>
                                    <br>
                                    <span><i>Diupload Tanggal:</i></span>
                                    <br>
                                    <span><i class="mdi mdi-clock"></i> {{\Carbon\Carbon::parse($data->created_at)->format('d-m-Y H:i:s');}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
