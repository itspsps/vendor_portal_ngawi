...
<div class="home_section_bg" style="box-shadow: 3px 3px 20px; background: rgb(255, 255, 255);background-size: cover; height: 100%; border-radius: 20px;">
    ...
    <div class="product_area deals_product">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <div class="pt-3 icon-login text-center wow fadeInUp" data-wow-delay="0.1s">
                <h2 class="mt-2" style="color: rgb(139, 128, 224); text-align: center;">Password</h2>
            </div>
            <div class="wow fadeInUp" data-wow-delay="0.1s">
                <div class="row g-3 p-4">
                    <form id="form_newpassword" method="POST" action="{{route('user.update_neweditpassword')}}">
                        @csrf
                        ...
                        <div class="col-md-6">
                            <div class="position-relative w-100 mt-3">
                                <input class="form-control @error('current_password') is-invalid @enderror border-1 rounded-pill w-100 ps-4 pe-5" disabled type="password" id="current_password" name="current_password" placeholder="Password" style="height: 40px;" value="{{old('current_password',$user->password_show)}}">
                                <button type="button" class="btn togglePassword shadow-none position-absolute top-0 end-0 mt-1 me-2"><i id="icon-password" class="fa fa-eye" style="color: rgb(139, 128, 224);"></i></button>
                        ...
                        <div class="col-md-6">
                            <div class="position-relative w-100 mt-3">
                                ...
                                <button type="button" class="btn togglePassword1 shadow-none position-absolute top-0 end-0 mt-1 me-2"><i id="icon-password" class="fa fa-eye" style="color: rgb(139, 128, 224);"></i></button>
                                @error('new_password')
                                <p class="text-danger" style="text-align: left !important;"><i class="fa fa-info-circle"></i>&nbsp;{{$message}}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="position-relative w-100 mt-3">
                                ...
                                <button type="button" class="btn togglePassword2 shadow-none position-absolute top-0 end-0 mt-1 me-2"><i id="icon-password" class="fa fa-eye" style="color: rgb(139, 128, 224);"></i></button>
                        ...
                        <div class="login_submit mt-3 wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <a id="btn_kembali" class="text-center" href="javascript:void(0);" data-bs-toggle="offcanvas" data-bs-target="#konfirmasiback" aria-controls="konfirmasiback">
    ...
    <div class="offcanvas offcanvas-bottom" style="box-shadow: 3px 3px 20px; border-radius: 20px 20px 0px 0px; height: max-content;" tabindex="-1" id="konfirmasiback" aria-labelledby="offcanvasBottomLabel">

        <div class="offcanvas-body small">
            <div class="text-center mt-3">
                Konfirmasi Keluar Halaman
                <br>
                <a href="{{route('user.edit_password',Auth::user()->id)}}" type="button" class="btn btn-sm btn-outline-primary" style="border-color: rgb(110, 97, 209); border-radius: 9px; width: 70px; box-shadow: 1px 2px 3px #4a4a4a;">Ya</a>
...
<script>
    // Tambahkan state baru ke history agar tombol "Back" bisa dipantau
    history.pushState(null, document.title, location.href);
    window.addEventListener('popstate', function(event) {
        const confirmLeave = confirm("Apakah kamu yakin ingin keluar dari halaman ini?");
        if (confirmLeave) {
            // Izinkan keluar
            history.back(); // Kembali satu langkah lagi (keluar benar-benar)
        } else {
            // Cegah keluar dengan dorong state lagi
            history.pushState(null, document.title, location.href);
        }
    });
</script>
<script>
    $(document).ready(function() {
        ...
        eyeIcon2.addEventListener("click", () => {
            ...
            // Update the eye icon class based on the password input type
            eyeIcon2.className = `fa fa-eye${passwordInput2.type === "password" ? "" : "-slash"}`;
        });
