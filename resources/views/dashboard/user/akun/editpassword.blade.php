    ...
    <div class="product_area deals_product">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <div class="pt-3 icon-login text-center wow fadeInUp" data-wow-delay="0.1s">
                <h4 class="mt-2" style="color: rgb(139, 128, 224); text-align: center;">VERIFIKASI</h4>
                <h6 class="mt-2" style="color: rgb(139, 128, 224); text-align: center;">&nbsp;EDIT&nbsp;PASSWORD</h6>
            </div>
            <div class="wow fadeInUp" data-wow-delay="0.1s">
                <form id="form_sendotp" action="javascript:void(0);" method="post">
                    ...
                    <div class="wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <div class="login_submit mt-2 p-4 wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <a id="btn_klik" class="text-center text-primary-gradient" href="{{route('user.account')}}">Kembali</a>
                        </div>
                    </div>
            </div>
            </form>
            ...
            Swal.fire({
                ...
                onBeforeOpen: () => {
                    $.ajax({
                        ...
                        url: "{{ route('user.sendOTPEditPassword') }}",
                        type: "POST",
                        dataType: 'json',
                        success: function(data) {
                            ...
                            if (data.code == 200) {
                                ...
                                offcanvasElement.show();
                                window.location.href = "{{url('user/input_otp')}}/" + data.data;
