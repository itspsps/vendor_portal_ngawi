...
<div class="home_section_bg mb-3" style="box-shadow: 3px 3px 20px; background: rgb(255, 255, 255);background-size: cover; height: 100%; border-radius: 20px;">
    ...
    <div class="container py-5 px-lg-5">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <h5 class="fw-medium"><b>PROFILE</b></h5>
        </div>
        <div class="row g-4">
            <div class="col-lg-4 col-sm-1 col-xs-0"></div>
            <div class="col-lg-4 col-sm-10 col-xs-12 text-center pt-4 wow fadeInUp" data-wow-delay="0.1s">
                <div class="position-relative rounded pb-4 px-4">
                    <form id="form_profile" method="POST" action="{{route('user.akun_update')}}">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-12 text-center">
                                <button class="btn btn-sm btn-success text-white" type="button" data-bs-toggle="offcanvas" data-bs-target="#konfirmasi" aria-controls="konfirmasi" style="border-radius: 9px; width: 70px; box-shadow: 1px 2px 3px #4a4a4a; width: 100%;">UPDATE</button>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="offcanvas offcanvas-bottom" style="box-shadow: 3px 3px 20px; border-radius: 20px 20px 0px 0px; height: max-content;" tabindex="-1" id="konfirmasi" aria-labelledby="offcanvasBottomLabel">

            <div class="offcanvas-body small">
                <div class="text-center mt-3">
                    Apakah data sudah benar?
                    <br>
                    <button id="btn_updateakun" class="btn btn-sm btn-outline-secondary" style="border-color: rgb(110, 97, 209); border-radius: 9px; width: 70px; box-shadow: 1px 2px 3px #4a4a4a;">Ya</button>
