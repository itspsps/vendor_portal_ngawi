                            ...
                            <div class="otp-container">
                                <form id="otp-form" method="post">
                                    ...
                                    <div class="login_submit wow fadeInUp" data-wow-delay="0.1s">
                                        ...
                                        <a id="btn_klik" class="text-center text-primary-gradient" href="{{route('user.edit_password',$data->user_id)}}">Kembali</a>
                                    </div>
                                </form>
                            </div>
            ...
            Swal.fire({
                ...
                onBeforeOpen: () => {
                    $.ajax({
                        ...
                        url: "{{ route('user.send_verified_otpEditPassword') }}",
                        type: "POST",
                        dataType: 'json',
                        success: function(data) {
                            console.log(data);
                            if (data.code == 200) {
                                window.location.href = "{{url('user/input_editpassword')}}/" + id_user;
                            } else {
