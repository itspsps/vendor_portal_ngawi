...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 mx-auto">
                            <div class="logo" style="text-align: right; ">
                                <a id="btn_home" href="{{route('user.home')}}" id="btn_home"><i class="fa fa-home" style="color: rgb(110, 97, 209); font-size: 30px;"></i></a>
                                <!-- <a id="btn_home" href="{{route('user.home')}}" id="btn_home"><img src="{{asset('home.png')}}" alt="" style="color: rgb(110, 97, 209);" width="90px"></a> -->
                            </div>
                        </div>
                    </div>
                    @else
                ...
                <div class="header_top">
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-6">
                            <div class="logo">
                                <a id="btn_home" href="{{route('user.home')}}" id="btn_home"><i class="fa fa-home" style="color: #4D006E;" width="90px"></i></a>
    ...
    <footer class="footer_widgets mx-auto">
        <p style="text-align: center">E-PROCUREMENT &copy; 2023</p>
