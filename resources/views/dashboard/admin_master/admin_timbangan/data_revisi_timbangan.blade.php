...
<script>
    $(document).ready(function() {
        var table = $('#data_longgrain').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: {
                url: "{{ route('master.data_revisi_timbangan_longgrain_index') }}",
            },
            columns: [{
        ...
        //     "iDisplayLength": 10,
        //     ajax: {
        //         url: "{{ route('master.data_revisi_timbangan_ciherang_index') }}",
        //     },
        //     columns: [{
        //             data: "id_admin_timbangan",
        ...
        var table2 = $('#data_pw').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: {
                url: "{{ route('master.data_revisi_timbangan_pandan_wangi_index') }}",
            },
            columns: [{
                    data: "id_admin_timbangan",
        ...
        var table3 = $('#data_kp').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: {
                url: "{{ route('master.data_revisi_timbangan_ketan_putih_index') }}",
            },
            columns: [{
                    data: "id_admin_timbangan",
...
<script type="text/javascript">
    ...
    $(function() {
                        ...
                        Swal.fire({
                            ...
                            onBeforeOpen: () => {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{route('master.revisi_timbangan_update')}}",
                                    type: "POST",
                                    dataType: 'json',
        ...
        $(document).on('click', '.to_show', function() {
            ...
            var url = "{{ route('master.show_timbangan_revisi') }}" + "/" + id;
            // console.log(url);
            $.ajax({
                type: "GET",
                url: url,
