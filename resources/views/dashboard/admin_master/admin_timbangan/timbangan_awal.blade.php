                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <div class="">
                                    ...
                                    <p style="color: blue;font-size: 10px;">(Edit Jika Nopol Kendaraan Salah)</p>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="">
...
<script>
    $(function() {
        var table = $('#data_longgrain').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.timbangan_awal_gb_longgrain_index') }}",
            columns: [{
        ...
        //     ],
        //     "iDisplayLength": 10,
        //     ajax: "{{ route('master.timbangan_awal_gb_ciherang_index') }}",
        //     columns: [{
        //             data: "id_admin_timbangan",
        ...
        var table2 = $('#data_pw').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.timbangan_awal_gb_pandan_wangi_index') }}",
            columns: [{
                    data: "id_admin_timbangan",
        ...
        var table3 = $('#data_kp').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.timbangan_awal_gb_ketan_putih_index') }}",
            columns: [{
                    data: "id_admin_timbangan",
...
<script>
    $(function() {
        var table = $('#datatable1').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.timbangan_awal_pk_index') }}",
            columns: [{
                    data: "id_admin_timbangan",
...
<script type="text/javascript">
    $(function() {
                        ...
                        Swal.fire({
                            ...
                            onBeforeOpen: () => {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{route('master.terima_tonase_awal')}}",
                                    type: "POST",
                                    dataType: 'json',
        ...
        $(document).on('click', '.to_show', function() {
            ...
            // console.log(id);
            var url = "{{ route('master.show_timbangan_awal') }}" + "/" + id;
            $.ajax({
                type: "GET",
                url: url,
