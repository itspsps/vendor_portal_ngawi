...
<script>
    $(function() {
        var table = $('#data_longgrain').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.data_timbangan_awal_gb_longgrain_index') }}",
            columns: [{
        ...
        //     ],
        //     "iDisplayLength": 10,
        //     ajax: "{{ route('master.data_timbangan_awal_gb_ciherang_index') }}",
        //     columns: [{
        //             data: "id_admin_timbangan",
        ...
        var table2 = $('#data_pw').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.data_timbangan_awal_gb_pandan_wangi_index') }}",
            columns: [{
                    data: "id_admin_timbangan",
        ...
        var table3 = $('#data_kp').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.data_timbangan_awal_gb_ketan_putih_index') }}",
            columns: [{
                    data: "id_admin_timbangan",
        ...
        var table4 = $('#datatable1').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.data_timbangan_awal_pk_index') }}",
            columns: [{
                    data: "id_admin_timbangan",
