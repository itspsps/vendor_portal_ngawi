...
<script>
    $(function() {
        var table = $('#data_longgrain').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.timbangan_akhir_gb_longgrain_index') }}",
            columns: [{
        ...
        var table2 = $('#data_pw').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.timbangan_akhir_gb_pandan_wangi_index') }}",
            columns: [{
                    data: "id_admin_timbangan",
        ...
        var table3 = $('#data_kp').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.timbangan_akhir_gb_ketan_putih_index') }}",
            columns: [{
                    data: "id_admin_timbangan",
        ...
        var table = $('#datatable1').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.timbangan_akhir_pk_index') }}",
            columns: [{
                    data: "id_admin_timbangan",
                        ...
                        Swal.fire({
                            ...
                            onBeforeOpen: () => {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{route('master.terima_tonase_akhir')}}",
                                    type: "POST",
                                    dataType: 'json',
