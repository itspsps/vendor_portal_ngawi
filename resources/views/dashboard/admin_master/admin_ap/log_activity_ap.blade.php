                ...
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            LOG ACTIVITY ADMIN AP
                        </h3>
                    </div>
                </div>
                <div class="kt-portlet__body">
                    <table class="table table-bordered" id="data_log_activity_ap">
                        <thead>
                            <tr>
...
<script>
    $(function() {
        var table = $('#data_log_activity_ap').DataTable({
            "scrollY": true,
            "scrollX": true,
            processing: true,
            serverSide: true,
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.log_activity_ap_index') }}",
            columns: [{
                    data: "id_aktivitas_ap",
