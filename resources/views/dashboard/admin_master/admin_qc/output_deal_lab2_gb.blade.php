    ...
    $(document).ready(function() {
        ...
        function load_data(from_date = '', to_date = '') {
            var table1 = $('#data_longgrain').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('master.output_deal_lab2_gb_longgrain_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table2 = $('#data_pw').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('master.output_deal_lab2_gb_pandan_wangi_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table3 = $('#data_kp').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('master.output_deal_lab2_gb_ketan_putih_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
    ...
    $(function() {
        $('#btn_export').click(function() {
            ...
            $.ajax({
                ...
                url: "{{route('master.download_deal_lab2_excel')}}",
                type: "POST",
                cache: false,
                xhrFields: {
                    responseType: 'blob'
