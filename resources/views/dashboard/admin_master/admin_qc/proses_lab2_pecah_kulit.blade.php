...
<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="modal fade" id="modal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form id="formfinishing_qc" class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('master.save_proses_lab2_pk') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('POST') }}
                        <div class="modal-header">
    ...
    <script>
        $(function() {
            var table = $('#datatable').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: "{{ route('master.proses_lab2_pecah_kulit_index') }}",
                columns: [{
                        data: "id_bid",
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $(document).on('click', '#btn_finishing_qc', function() {
                ...
                var url = "{{ route('master.show_lab2_pk') }}" + "/" + id;
