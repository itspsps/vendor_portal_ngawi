    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="col-xl-12 col-lg-12 col-md-12 order-lg-1 order-xl-1">
            <div class="kt-portlet kt-portlet--mobile">
                ...
                <form class="" method="post" action="{{route('master.download_output_lab2_excel')}}" enctype="multipart/form-data">
    ...
    $(document).ready(function() {
        ...
        function load_data(from_date = '', to_date = '') {
            var table = $('#datatable').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('master.output_deal_lab2_pk_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
    ...
    $(function() {
        $('body').on('click', '#approved_lab2_pk', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{route('master.approve_lab2_pk')}}/" + cek,
                        type: "GET",
                        error: function() {
