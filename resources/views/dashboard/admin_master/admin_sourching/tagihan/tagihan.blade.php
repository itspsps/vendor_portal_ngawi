    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="modal fade" id="modal_upload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form class="m-form m-form--fit m-form--label-align-right" id="form_tagihan" method="post" action="{{ route('master.upload_tagihan') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('POST') }}
        ...
        <div class="modal fade" id="modal_edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <form class="m-form m-form--fit m-form--label-align-right" id="form_tagihan_update" method="post" action="{{ route('master.update_tagihan') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('POST') }}
                        <div class="modal-header">
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#datatable').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.tagihan_index') }}",
            columns: [{
                    data: "id",
        ...
        var table1 = $('#datatable1').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.tagihan1_index') }}",
            columns: [{
                    data: "id",
    ...
    $(function() {
        ...
        $('body').on('click', '#btn_hapus_tagihan', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{route('master.delete_tagihan')}}/" + id,
                        type: "GET",
                        error: function() {
                            Swal.fire({
                                title: 'Gagal!',
