                                                        ...
                                                        <div class="col-xl-12">
                                                            <div class="kt-section__body">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input type="file" class="form-control" id="gambar_broadcast" name="gambar_broadcast">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <div class="">
                                    ...
                                    <input id="gambar_broadcast_update" name="gambar_broadcast_update" placeholder="" type="file" class="form-control m-input">
        ...
        $(document).on('click', '.toedit', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#gambar_broadcast_update').empty();
                    if (image !== null) {
                        $('#gambar_broadcast').append(
                            '<div class="col-md-12 col-lg-4"><img src="https://ngawi.suryapangansemesta.store/public/img/broadcast/' +
                            image + '" width="100%" /></div>');
                    }
                }
            });
