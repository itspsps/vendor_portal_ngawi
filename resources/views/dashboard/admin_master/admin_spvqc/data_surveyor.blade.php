                    ...
                    <div class="accordion  accordion-toggle-arrow" id="accordionExample4">
                        <div class="card">
                            ...
                            <div id="collapseOne4" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample4">
                                <div class="card-body">
                                    <form class="kt-form" id="form_surveyor" action="{{ route('master.save_surveyor') }}" method="post" enctype="multipart/form-data">
                                        @csrf
        ...
        <div class="modal fade" id="modal_edit_surveyor" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form id="formedit_surveyor" class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('master.update_surveyor') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('POST') }}
...
<script>
    ...
    $(document).ready(function() {
        ...
        var table = $('#datatable').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.data_surveyor_index') }}",
            columns: [{
                    data: "id_surveyor",
    ...
    $(function() {
        ...
        $('body').on('click', '#btn_hapus', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{route('master.delete_surveyor')}}/" + id,
                        type: "GET",
                        error: function() {
                            Swal.fire({
                                title: 'Gagal!',
