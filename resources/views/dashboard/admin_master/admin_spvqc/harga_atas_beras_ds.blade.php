...
<script>
    $(function() {
        var table = $('#table-harga-atas').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.harga_atas_beras_ds_index') }}",
            columns: [{
                    data: "id_bid",
                        ...
                        Swal.fire({
                            ...
                            onBeforeOpen: () => {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{route('master.store_harga_atas_beras_ds')}}",
                                    type: "POST",
                                    dataType: 'json',
                        ...
                        Swal.fire({
                            ...
                            onBeforeOpen: () => {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{route('master.update_harga_atas_beras_ds')}}",
                                    type: "POST",
                                    dataType: 'json',
                                    success: function(data) {
                                        $('#table-harga-atas').DataTable().ajax.reload();
    ...
    $(document).on('click', '.to_harga_atas', function() {
        ...
        var url = "{{route('master.show_harga_atas_beras_ds')}}" + "/" + id;
        console.log(url);
        $.ajax({
            type: "GET",
            url: url,
