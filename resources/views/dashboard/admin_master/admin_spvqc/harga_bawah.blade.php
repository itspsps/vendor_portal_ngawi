                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-12">
                                                            <div class="kt-section__body">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label class="col-xl-3 col-lg-3 col-form-label">Min&nbsp;Tolerensi&nbsp;Harga&nbsp;Bawah</label>
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input type="text" class="form-control" required id="min_harga_bawah" name="min_harga_bawah" value="">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-xl-3 col-lg-3 col-form-label">Max Tolerensi Harga Bawah</label>
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input type="text" class="form-control" required id="max_harga_bawah" name="max_harga_bawah" value="">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                    ...
                    <table class="table table-bordered" id="table-harga-bawah">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center;width:auto">Min Tolerenasi Harga Bawah</th>
                                <th style="text-align: center;width:auto">Max Tolerenasi Harga Bawah</th>
        ...
        <div class="modal fade" id="modal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form id="formupdatehargabawah" class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('master.update_harga_bawah_gabah_basah') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Update Harga Bawah</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <div class="">
                                    <label>Min Tolerensi Harga Bawah</label>
                                    <input type="text" class="form-control m-input" required id="min_harga_bawah_update" name="min_harga_bawah_update" value="">
                                </div>
                            </div>
                            <div class="form-group ">
                                <div class="">
                                    <label>Max Tolerensi Harga Bawah</label>
                                    <input type="text" class="form-control m-input" required id="max_harga_bawah_update" name="max_harga_bawah_update" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="">
...
<script>
    $(function() {
        var table = $('#table-harga-bawah').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.harga_bawah_gabah_basah_index') }}",
            columns: [{
                    data: "id_harga_bawah",
                ...
                {
                    data: 'min_toleransi_harga_bawah_gb'
                },
                {
                    data: 'max_toleransi_harga_bawah_gb'
                },
                {
...
<script>
    $(document).ready(function() {
        $(document).on('click', '#btn_save', function(e) {
            ...
            var min_harga_bawah = $('#min_harga_bawah').val();
            var max_harga_bawah = $('#max_harga_bawah').val();
            ...
            Swal.fire({
                ...
                if ($('#waktu_harga_bawah').val() == '' || $('#harga_bawah').val() == '' || $('#min_harga_bawah').val() == '' || $('#max_harga_bawah').val() == '') {
                            ...
                            onBeforeOpen: () => {
                                ...
                                $.ajax({
                                    data: {
                                        ...
                                        min_harga_bawah: min_harga_bawah,
                                        max_harga_bawah: max_harga_bawah,
                                    },
                                    url: "{{route('master.store_harga_bawah_gabah_basah')}}",
                                    type: "POST",
                                    dataType: 'json',
    ...
    $(document).ready(function() {
        $(document).on('click', '#btn_update', function(e) {
            ...
            var min_harga_bawah_update = $('#min_harga_bawah_update').val();
            var max_harga_bawah_update = $('#max_harga_bawah_update').val();
            ...
            Swal.fire({
                ...
                if ($('#waktu_harga_bawah_update').val() == '' || $('#harga_bawah_update').val() == '' || $('#min_harga_bawah_update').val() == '' || $('#max_harga_bawah_update').val() == '') {
                    Swal.fire({
                        title: 'Info !!',
                        text: 'Data Harus Terisi Semua',
                        icon: 'warning',
                            ...
                            onBeforeOpen: () => {
                                ...
                                $.ajax({
                                    data: {
                                        ...
                                        min_harga_bawah_update: min_harga_bawah_update,
                                        max_harga_bawah_update: max_harga_bawah_update,
                                        harga_bawah_update: harga_bawah_update,
                                        waktu_harga_bawah_update: waktu_harga_bawah_update,
                                    },
                                    url: "{{route('master.update_harga_bawah_gabah_basah')}}",
                                    type: "POST",
                                    dataType: 'json',
                                    success: function(data) {
                                        $('#table-harga-bawah').DataTable().ajax.reload();
    ...
    $('body').on('click', '#btn_delete', function() {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "{{route('master.destroy_harga_bawah_gabah_basah')}}/" + cek,
                    type: "GET",
                    error: function() {
    ...
    $(document).on('click', '.to_harga_bawah', function() {
        ...
        var url = "{{route('master.show_harga_bawah_gabah_basah')}}" + "/" + id;
        // console.log(url);
        $.ajax({
            type: "GET",
            url: url,
            success: function(response) {
                ...
                $('#min_harga_bawah_update').val(parsed.min_toleransi_harga_bawah_gb);
                $('#max_harga_bawah_update').val(parsed.max_toleransi_harga_bawah_gb);
                $('#harga_bawah_update').val(parsed.harga_bawah_gb);
                $('#waktu_harga_bawah_update').val(parsed.waktu_harga_bawah_gb);
                // console.log(parsed.max_toleransi_harga_bawah_gb);
            }
        });
    });
</script>
