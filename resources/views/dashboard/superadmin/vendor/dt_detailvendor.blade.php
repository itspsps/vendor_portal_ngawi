...
<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
                            ...
                            <div class="m-portlet__body">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="m_tabs_1_1" role="tabpanel">
                                        <form id="form_update_npwp" action="{{route('sourching.vendor_update_npwp')}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="m-portlet__body">
                                    ...
                                    <div class="tab-pane" id="m_tabs_1_2" role="tabpanel">
                                        <div class="m-portlet__body">
                                            <form id="form_update_ktp" action="{{route('sourching.vendor_update_ktp')}}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="tab-pane" id="m_tabs_1_3" role="tabpanel">
                                        <form id="form_update_pembayaran" action="{{route('sourching.vendor_update_pembayaran')}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="m-portlet__body">
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-10">
                                                        <select class="form-control" onchange="bankCheck(this);" name="nama_bank" id="nama_bank" required="required">
                                                            ...
                                                            <option value="BBRI" @if(old('nama_bank', $data->BankBranchCode) === 'BBRI') selected @endif >BANK BRI</option>
                                                            <option value="BMRI" @if(old('nama_bank', $data->BankBranchCode) === 'BMRI') selected @endif >BANK MANDIRI</option>
                                                            <option value="BB00700" @if(old('nama_bank', $data->BankBranchCode) === 'BB00700') selected @endif >BANK BCA</option>
                                                        </select>
                                            ...
                                            <button id="btn_updatepembeyaran" class="btn btn-info btn-sm pull-right"><i class="fa fa-save"></i>UPDATE PEMBAYARAN</button>
                                        </form>
                                    </div>
                                    <div class="tab-pane" id="m_tabs_1_4" role="tabpanel">
                                        <form id="form_update_profil" action="{{route('sourching.vendor_update_profil')}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="m-portlet__body">
                                                <div class="form-group m-form__group row">
                                                    <label for="nomer_hp" class="col-2 col-form-label">ID VENDOR (EPICOR)</label>
                                                    <div class="col-10">
                                                        <input class="form-control m-input" type="text" id="vendor_id" name="vendor_id" required="required" readonly placeholder="ID Vendor" value="{{$data->vendorid}}">
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-10">
                                                        <input type="file" accept="application/pdf" class="form-control m-input" name="file_pakta" id="file_pakta"><br>
                                                        <!-- <img id="file_gambar_pakta" src="{{asset('img/pakta_integritas/profile_user/'.$data->pakta_integritas)}}" width="75%" alt=""> -->
                                                        <iframe id="file_gambar_pakta" src="{{asset('img/pakta_integritas/profile_user/'.$data->pakta_integritas)}}" style="height: 500px; width: 100%;"></iframe>
                                                        <!-- <div id="file_gambar_pakta" style="height: 400px; width: 100%;"></div> -->
                                                    </div>
                                                </div>
                                                <div class="form-group m-form__group row">
    ...
    <script type="text/javascript">
        ...
        $('#file_pakta').change(function() {
            ...
            console.log(reader);
            reader.onload = (e) => {
                // PDFObject.embed("https://ngawi.suryapangansemesta.store/public/img/pakta_integritas/profile_user/" + e.target.result, "#file_gambar_pakta");
                // PDFObject.embed(e.target.result, "#file_gambar_pakta");
        ...
        $(function() {
            ...
            $(document).on('click', '#btn_updateprofil', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        if ($('#vendor_id').val() == '' || $('#nama_vendor').val() == '' || $('email').val() == '' || $('#password_show').val() == '' || $('#nomer_hp').val() == '' || $('#username').val() == '') {
                            Swal.fire({
                                title: 'Info !!',
                                text: 'Data Harus Terisi Semua',
                                icon: 'warning',
