            ...
            <table class="table1 mt--3" align="left">
                <tr>
                    ...
                    <td align="center" style="vertical-align:top;">
                        ...
                        <p style="font-size: 12px; margin-top: -4px;">JL. RAYA NGAWI MADIUN KM 13 TAMBAKROMO KECAMATAN GENENG<br>KAB. NGAWI JAWA TIMUR 63271 INDONESIA</p>
                    </td>
                    <td width="4"></td>
                </tr>
            </table>
            <hr style="width:100%;text-align:left;height:1px;background-color: black;">
        </div>
    </div>
