                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="m_tabs_3_1" role="tabpanel">
                            <ul class="nav nav-pills float-right" role="tablist">
                                <li class="nav-item mt-3">
                                    <a class="btn btn-sm btn-secondary btn-outline-hover-secondary active" id role="tab" aria-controls="tabs_lab1_1" aria-selected="true" data-toggle="tab" href="#tabs_lab1_1"><i class="flaticon2-list-1"></i>PENGAJUAN APPROVE</a>
                                </li>

                                <li class="nav-item mt-3">
                                    <a class="btn btn-sm btn-secondary btn-outline-hover-success" id="notif_swal_bongkar" role="tab" aria-controls="tabs_lab1_3" aria-selected="false" data-toggle="tab" href="#tabs_lab1_3"><i class="flaticon2-list-1"></i>APPROVED BONGKAR</a>
                                </li>
                                <li class="nav-item mt-3">
                                    <a class="btn btn-sm btn-secondary btn-outline-hover-danger" id="notif_swal_tolak" role="tab" aria-controls="tabs_lab1_4" aria-selected="false" data-toggle="tab" href="#tabs_lab1_4"><i class="flaticon2-list-1"></i>APPROVED TOLAK</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tabs_lab1_3" role="tabpanel">
                                    <table class="table table-bordered" id="data_longgrain_approved_bongkar">
                                        <thead>
                                            <tr>
                                                <th style="text-align: center;width:2%">No</th>
                                                <th style="text-align: center;width:auto">&nbsp;&nbsp;&nbsp;&nbsp;Nama&nbsp;Item&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                ...
                                <div class="tab-pane" id="tabs_lab1_4" role="tabpanel">
                                    <table class="table table-bordered" id="data_longgrain_approved_tolak">
                                        <thead>
                                            <tr>
                                                <th style="text-align: center;width:2%">No</th>
                                                <th style="text-align: center;width:auto">&nbsp;&nbsp;&nbsp;&nbsp;Nama&nbsp;Item&nbsp;&nbsp;&nbsp;&nbsp;</th>
    ...
    $(document).ready(function() {
        ...
        function load_data(from_date = '', to_date = '') {
            var table = $('#data_longgrain').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('qc.spv.new_output_lab1_gb_longgrain_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table4 = $('#data_longgrain_approved_bongkar').DataTable({
                "scrollY": true,
                "scrollX": true,
                processing: true,
                language: {
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('qc.spv.output_lab1_gb_longgrain_approvedbongkar_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table5 = $('#data_longgrain_approved_tolak').DataTable({
                "scrollY": true,
                "scrollX": true,
                processing: true,
                language: {
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('qc.spv.output_lab1_gb_longgrain_approvedtolak_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
        ...
        $('#filter').click(function() {
            ...
            if (from_date != '' && to_date != '') {
                ...
                $('#data_longgrain_approved_tolak').DataTable().destroy();
                $('#data_longgrain_approved_bongkar').DataTable().destroy();
                        ...
                        onBeforeOpen: () => {
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    ...
                                    $('#data_longgrain_approved_bongkar').DataTable().ajax.reload();
                                    $('#data_longgrain_approved_tolak').DataTable().ajax.reload();
