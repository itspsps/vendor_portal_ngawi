                    ...
                    <!-- <div class="accordion  accordion-toggle-arrow" id="accordionExample4">
                        <div class="card">
                            ...
                            <div id="collapseOne4" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample4">
                                <div class="card-body">
                                    <form class="kt-form" id="formaddreward" action="{{ route('qc.spv.parameter_lab_pk_reward_hampa_store') }}" method="post" enctype="multipart/form-data">
                                        @csrf
    ...
    <div class="kt-form__actions">
        ...
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
            <div class="modal fade" id="modal_update_po" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('qc.spv.parameter_lab_pk_reward_update') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('POST') }}
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <div class="">
                                        ...
                                        <input id="tanggal_po_parameter_lab_pk_reward" required name="tanggal_po_parameter_lab_pk_reward" placeholder="" type="date" class="form-control m-input">
                                    </div>
                                </div>
            ...
            <div class="modal fade" id="modal_edit_ka" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('qc.spv.parameter_lab_pk_reward_kadar_air_update') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('POST') }}
                            <div class="modal-header">
            ...
            <div class="modal fade" id="modal_edit_hampa" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('qc.spv.parameter_lab_pk_reward_hampa_update') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('POST') }}
                            <div class="modal-header">
            ...
            <div class="modal fade" id="modal_edit_tr" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('qc.spv.parameter_lab_pk_reward_tr_update') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('POST') }}
                            <div class="modal-header">
            ...
            <div class="modal fade" id="modal_edit_katul" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('qc.spv.parameter_lab_pk_reward_katul_update') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('POST') }}
                            <div class="modal-header">
            ...
            <div class="modal fade" id="modal_edit_butirpatah" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('qc.spv.parameter_lab_pk_reward_butir_patah_update') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('POST') }}
                            <div class="modal-header">
...
<script>
    $(function() {
        var table = $('#table-parameter-lab-ka').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('qc.spv.parameter_lab_pk_reward_kadar_air_index') }}",
            columns: [{
                    data: "id_bid",
        ...
        var table1 = $('#table-parameter-lab-hampa').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('qc.spv.parameter_lab_pk_reward_hampa_index') }}",
            columns: [{
                    data: "id_bid",
        ...
        var table2 = $('#table-parameter-lab-tr').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('qc.spv.parameter_lab_pk_reward_tr_index') }}",
            columns: [{
                    data: "id_bid",
        ...
        var table3 = $('#table-parameter-lab-katul').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('qc.spv.parameter_lab_pk_reward_katul_index') }}",
            columns: [{
                    data: "id_bid",
        ...
        var table4 = $('#table-parameter-lab-butirpatah').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('qc.spv.parameter_lab_pk_reward_butir_patah_index') }}",
            columns: [{
                    data: "id_bid",
...
<script type="text/javascript">
    $(function() {
        $(document).on('click', '.to_parameter_ka', function() {
            ...
            var url = "{{ route('qc.spv.parameter_lab_pk_reward_kadar_air_show') }}" + "/" + id;
            console.log(url);
            $.ajax({
                type: "GET",
                url: url,
        ...
        $(document).on('click', '.to_parameter_hampa', function() {
            var id = $(this).attr("name");
            var url = "{{ route('qc.spv.parameter_lab_pk_reward_hampa_show') }}" + "/" + id;
            console.log(url);
            $.ajax({
                type: "GET",
                url: url,
        ...
        $(document).on('click', '.to_parameter_tr', function() {
            var id = $(this).attr("name");
            var url = "{{ route('qc.spv.parameter_lab_pk_reward_tr_show') }}" + "/" + id;
            console.log(url);
            $.ajax({
                type: "GET",
                url: url,
        ...
        $(document).on('click', '.to_parameter_katul', function() {
            var id = $(this).attr("name");
            var url = "{{ route('qc.spv.parameter_lab_pk_reward_katul_show') }}" + "/" + id;
            console.log(url);
            $.ajax({
                type: "GET",
                url: url,
        ...
        $(document).on('click', '.to_parameter_butirpatah', function() {
            var id = $(this).attr("name");
            var url = "{{ route('qc.spv.parameter_lab_pk_reward_butir_patah_show') }}" + "/" + id;
            console.log(url);
            $.ajax({
                type: "GET",
                url: url,
    ...
    $(document).ready(function() {
        ...
        $('body').on('click', '#btn_delete_ka', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{route('qc.spv.parameter_lab_pk_reward_kadar_air_destroy')}}/" + id,
                        type: "GET",
                        error: function() {
                            Swal.fire({
                                title: 'Gagal!',
        ...
        $('body').on('click', '#btn_delete_hampa', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{route('qc.spv.parameter_lab_pk_reward_hampa_destroy')}}/" + id,
                        type: "GET",
                        error: function() {
                            Swal.fire({
                                title: 'Gagal!',
        ...
        $('body').on('click', '#btn_delete_tr', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{route('qc.spv.parameter_lab_pk_reward_tr_destroy')}}/" + id,
                        type: "GET",
                        error: function() {
                            Swal.fire({
                                title: 'Gagal!',
        ...
        $('body').on('click', '#btn_delete_katul', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{route('qc.spv.parameter_lab_pk_reward_katul_destroy')}}/" + id,
                        type: "GET",
                        error: function() {
                            Swal.fire({
                                title: 'Gagal!',
        ...
        $('body').on('click', '#btn_delete_butirpatah', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{route('qc.spv.parameter_lab_pk_reward_butir_patah_destroy')}}/" + id,
                        type: "GET",
                        error: function() {
                            Swal.fire({
                                title: 'Gagal!',
