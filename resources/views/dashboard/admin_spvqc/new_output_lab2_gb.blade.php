                ...
                <div class="kt-portlet__body">
                    ...
                    <div class="tab-content">
                        <ul class="nav nav-pills float-right" role="tablist">
                            ...
                            <li class="nav-item mt-3">
                                <a class="btn btn-sm btn-secondary btn-outline-hover-success" role="tab" aria-controls="lab2_2" aria-selected="false" data-toggle="tab" href="#lab2_2"><i class="flaticon2-list-1"></i>APPROVED SUCCESS</a>
                            </li>
                        </ul>
                        <div class="tab-content">
