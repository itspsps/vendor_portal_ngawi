                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="m_tabs_3_1" role="tabpanel">
                            <ul class="nav nav-pills float-right" role="tablist">
                                ...
                                <li class="nav-item mt-3">
                                    <a class="btn btn-sm btn-secondary btn-outline-hover-success" role="tab" aria-controls="tabs_lab1_3" aria-selected="false" data-toggle="tab" href="#tabs_lab1_3"><i class="flaticon2-list-1"></i>APPROVED BONGKAR</a>
                                </li>
                                <li class="nav-item mt-3">
                                    <a class="btn btn-sm btn-secondary btn-outline-hover-danger" role="tab" aria-controls="tabs_lab1_4" aria-selected="false" data-toggle="tab" href="#tabs_lab1_4"><i class="flaticon2-list-1"></i>APPROVED TOLAK</a>
                                </li>
                            </ul>
                            <div class="tab-content">
