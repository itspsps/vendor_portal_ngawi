        ...
        <div class="modal fade" id="modaloutputnegogb" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form id="form_resultrevisigb" class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('qc.spv.save_revisi_harga_gb') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('POST') }}
...
<script>
    function cekNetto() {
        ...
        $('#output_harga_akhir').val(parseInt(harga_akhir_revisi) + parseInt(reaksiharga));
    }
    ...
    $(document).on('click', '#btn_output_gb', function() {
        ...
        $('input[id=harga_akhir]').val(hargaawal - 14);
    ...
    $(document).ready(function() {
        ...
        var table = $('#data_longgrain').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('qc.spv.revisi_harga_gb_longgrain_index') }}",
            columns: [{
                    data: "id_bid",
        ...
        //     ],
        //     "iDisplayLength": 10,
        //     ajax: "{{ route('qc.spv.revisi_harga_gb_ciherang_index') }}",
        //     columns: [{
        //             data: "id_bid",
        ...
        var table2 = $('#data_pw').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('qc.spv.revisi_harga_gb_pandan_wangi_index') }}",
            columns: [{
                    data: "id_bid",
        ...
        var table3 = $('#data_kp').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('qc.spv.revisi_harga_gb_ketan_putih_index') }}",
            columns: [{
                    data: "id_bid",
