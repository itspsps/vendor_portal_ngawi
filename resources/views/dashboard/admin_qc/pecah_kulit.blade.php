    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
        ...
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
            ...
            @foreach ($plan_hpp_gabah_basah as $data)
                <input type="hidden" class="val_plan_hpp" value="{{ $data->min_tp_gb . '#' . $data->max_tp_gb . '#' . $data->harga_gb }}">
            @endforeach
                        ...
                        <form id="formfinishing_qc" class="m-form m-form--fit m-form--label-align-right" method="post"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="m-form__group form-group">
                                    ...
                                    <input type="number" step="any" required name="ka_ks_lab2_gb" id="ka_ks_lab2_gb" class="form-control m-input" value="26.3">
                                </div>
                                <div class="m-form__group form-group">
                                    <label for="">KA KG</label>
                                    <input type="number" step="any" required name="ka_kg_lab2_gb" id="ka_kg_lab2_gb" class="form-control m-input" value="13.3">
                                </div>
                                <div class="m-form__group form-group">
                                    <label for="">Berat Sample Awal KS</label>
                                    <input type="number" step="any" required name="berat_sample_awal_ks_lab2_gb" id="berat_sample_awal_ks_lab2_gb" class="form-control m-input" value="150">
                                </div>
                                <div class="m-form__group form-group">
                                    <label for="">Berat Sample Awal KG </label>
                                    <input type="number" step="any" required name="berat_sample_awal_kg_lab2_gb" id="berat_sample_awal_kg_lab2_gb" class="form-control m-input" value="132.0">
                                </div>
                                <div class="m-form__group form-group">
                                    <label for="">Berat Sample Akhir KG </label>
                                    <input type="number" step="any" required name="berat_sample_akhir_kg_lab2_gb" id="berat_sample_akhir_kg_lab2_gb" class="form-control m-input" value="130.6">
                                </div>
                                <div class="m-form__group form-group">
                                    <label for="">Berat Sample PK</label>
                                    <input type="number" step="any" required name="berat_sample_pk_lab2_gb" id="berat_sample_pk_lab2_gb" class="form-control m-input" value="105.4">
                                </div>
                                <div class="m-form__group form-group">
                                    <label for="">Berat Sample Beras</label>
                                    <input type="number" step="any" required name="berat_sample_beras_lab2_gb" id="berat_sample_beras_lab2_gb" class="form-control m-input" value="90.1">
                                </div>
                                <div class="m-form__group form-group">
                                    <label for="">WH</label>
                                    <input type="number" step="any" required name="wh_lab2_gb" id="wh_lab2_gb" class="form-control m-input" value="48.5">
                                </div>
                                <div class="m-form__group form-group">
                                    <label for="">TP</label>
                                    <input type="number" step="any" required name="tp_lab2_gb" id="tp_lab2_gb" class="form-control m-input" value="3.29">
                                </div>
                                <div class="m-form__group form-group">
                                    <label for="">MD</label>
                                    <input type="number" step="any" required name="md_lab2_gb" id="md_lab2_gb" class="form-control m-input" value="136">
                                </div>
                                <div class="m-form__group form-group">
                                    <label for="">Broken Setelah Bongkar</label>
                                    <input type="number" step="any" required name="broken_setelah_bongkar_lab2_gb" id="broken_setelah_bongkar_lab2_gb" class="form-control m-input" value="30.2">
                                </div>
                                <div class="m-form__group form-group">
                                    <label for="">Plan Harga (Kg)</label>
                                    <input readonly type="number" step="any" required name="plan_harga_lab2_gb" id="plan_harga_lab2_gb"
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@9"></script>
    <script>
        $(function() {
            var table = $('#datatable').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: "{{ route('qc.lab.proses_lab2_gabah_basah_index') }}",
                columns: [{
                        data: "id_bid",
    ...
    <script type="text/javascript">
        $(function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                if( $('#z_yang_dibawa').val()=='' | $('#broken_setelah_bongkar_lab2_gb').val()=='' | $('#tp_lab2_gb').val()=='' | $('#berat_sample_pk_lab2_gb').val()=='' | $('#ka_ks_lab2_gb').val()=='' | $('#ka_kg_lab2_gb').val()=='' | $('#berat_sample_akhir_kg_lab2_gb').val()=='' | $('#berat_sample_awal_ks_lab2_gb').val()=='' | $('#berat_sample_awal_kg_lab2_gb').val()=='' | $('#md_lab2_gb').val()=='' | $('#tp_lab2_gb').val()=='' | $('#wh_lab2_gb').val()=='' | $('#berat_sample_beras_lab2_gb').val()=='') {
                    Swal.fire('Gagal!', 'Data Harus Diisi Semua', 'error')
                } else if($('#plan_harga_lab2_gb').val()=='' | $('#plan_harga_lab2_gb').val()=='0'){
            ...
            $(document).on('click', '#btn_finishing_qc', function() {
                ...
                var url = "{{ route('qc.lab.show_lab2_gb') }}" + "/" + id;
    ...
    <script>
        ...
        var ka_ks_lab2_gb = document.getElementById('ka_ks_lab2_gb');
        var ka_kg_lab2_gb = document.getElementById('ka_kg_lab2_gb');
        var berat_sample_awal_ks_lab2_gb = document.getElementById('berat_sample_awal_ks_lab2_gb');
        var berat_sample_awal_kg_lab2_gb = document.getElementById('berat_sample_awal_kg_lab2_gb');
        var berat_sample_akhir_kg_lab2_gb = document.getElementById('berat_sample_akhir_kg_lab2_gb');
        var berat_sample_pk_lab2_gb = document.getElementById('berat_sample_pk_lab2_gb');
        var berat_sample_beras_lab2_gb = document.getElementById('berat_sample_beras_lab2_gb');
        var wh_lab2_gb = document.getElementById('wh_lab2_gb');
        var tp_lab2_gb = document.getElementById('tp_lab2_gb');
        var md_lab2_gb = document.getElementById('md_lab2_gb');
        var broken_setelah_bongkar_lab2_gb = document.getElementById('broken_setelah_bongkar_lab2_gb');
        ...
        var plan_harga_lab2_gb = document.getElementById('plan_harga_lab2_gb');
        // tambahan hidden
        ...
        function rumus() {
            var hasil = "0";
            if (ka_ks_lab2_gb.value == 0 || ka_ks_lab2_gb.value == '' ||
                ka_kg_lab2_gb.value == 0 || ka_kg_lab2_gb.value == '' ||
                berat_sample_awal_ks_lab2_gb.value == 0 || berat_sample_awal_ks_lab2_gb.value == '' ||
                berat_sample_awal_kg_lab2_gb.value == 0 || berat_sample_awal_kg_lab2_gb.value == '' ||
                berat_sample_akhir_kg_lab2_gb.value == 0 || berat_sample_akhir_kg_lab2_gb.value == '' ||
                berat_sample_pk_lab2_gb.value == 0 || berat_sample_pk_lab2_gb.value == '' ||
                berat_sample_beras_lab2_gb.value == 0 || berat_sample_beras_lab2_gb.value == '' ||
                wh_lab2_gb.value == 0 || wh_lab2_gb.value == '' ||
                tp_lab2_gb.value == 0 || tp_lab2_gb.value == '' ||
                md_lab2_gb.value == 0 || md_lab2_gb.value == '' ||
                broken_setelah_bongkar_lab2_gb.value == 0 || broken_setelah_bongkar_lab2_gb.value == '') {
                hasil = "0";

            } else {
                var berat_tonase = hasil_akhir_tonase.value;
                var id_penerimaan = lab1_id_penerimaan_po_gb.value;
                    kg_after_adjust_hampa.value = berat_sample_akhir_kg_lab2_gb.value;
                ...
                var perhitungan_prsentase_kg_pk = (berat_sample_pk_lab2_gb.value / (kg_after_adjust_hampa.value / 100));
                ...
                var perhitungan_presentase_putih = berat_sample_beras_lab2_gb.value / (kg_after_adjust_hampa.value / 100);
                ...
                var h_broken = broken_setelah_bongkar_lab2_gb.value;
                ...
                [].forEach.call(elems, function(el) {
                    ...
                    if (tp_lab2_gb.value >= arr_hpp[0] && tp_lab2_gb.value < arr_hpp[1]) {
                        std_hpp_aktual = arr_hpp[2];
                        // console.log(std_hpp_aktual);
                    } else if (tp_lab2_gb.value >= arr_hpp[1]){
                        std_hpp_aktual = arr_hpp[2];
                ...
                var perhitungan_hampa = (berat_sample_awal_kg_lab2_gb.value - berat_sample_akhir_kg_lab2_gb.value) / (berat_sample_awal_kg_lab2_gb
                    .value / 100);
            ...
            plan_harga_lab2_gb.value = hasil;
        }

        lab1_id_penerimaan_po_gb.addEventListener('keyup', function(e) {
            rumus();
        });
        ka_ks_lab2_gb.addEventListener('keyup', function(e) {
            rumus();
        });
        ka_kg_lab2_gb.addEventListener('keyup', function(e) {
            rumus();
        });
        berat_sample_awal_ks_lab2_gb.addEventListener('keyup', function(e) {
            rumus();
        });
        berat_sample_awal_kg_lab2_gb.addEventListener('keyup', function(e) {
            rumus();
        });
        berat_sample_akhir_kg_lab2_gb.addEventListener('keyup', function(e) {
            rumus();
        });
        berat_sample_pk_lab2_gb.addEventListener('keyup', function(e) {
            rumus();
        });
        berat_sample_beras_lab2_gb.addEventListener('keyup', function(e) {
            rumus();
        });
        wh_lab2_gb.addEventListener('keyup', function(e) {
            rumus();
        });
        tp_lab2_gb.addEventListener('keyup', function(e) {
            rumus();
        });
        md_lab2_gb.addEventListener('keyup', function(e) {
            rumus();
        });
        broken_setelah_bongkar_lab2_gb.addEventListener('keyup', function(e) {
            rumus();
        });
