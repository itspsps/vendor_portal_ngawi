                                ...
                                <div id="collapseOne4" class="collapse" aria-labelledby="headingOne"
                                    ...
                                    <div class="card-body">
                                        <form id="formgt04" class="kt-form" id="kt_apps_user_add_user_form"
                                            action="{{ route('qc.lab.store_potongan_pecah_kulit') }}" method="post"
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form id="formupdategt04" class="m-form m-form--fit m-form--label-align-right" method="post"
                            action="{{ route('qc.lab.update_potongan_pecah_kulit') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('POST') }}
    ...
    <script>
        $(function() {
            var table = $('#potongan').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: "{{ route('qc.lab.potongan_pecah_kulit_index') }}",
                columns: [{
                        data: "id_harga_bawah",
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#btn_delete', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{url('qc/lab/destroy_potongan_pecah_kulit')}}/" + cek,
                        type: "GET",
                        error: function() {
            ...
            $(document).on('click', '.to_potongan_bongkar_gt_04', function() {
                ...
                var url = '{{ route('qc.lab.show_potongan_pecah_kulit') }}' + "/" + id;
                console.log(url);
                $.ajax({
                    type: "GET",
                    url: url,
                    success: function(response) {
                        ...
                        $('#id_potongan_bongkar_gt_04_update').val(parsed.id_potongan_bongkar_gt_04_pk);
                        $('#transparasi').val(parsed.transparasi_pk);
                        $('#potongan_bongkar_gt_04_update').val(parsed.potongan_bongkar_gt_04_pk);
                        $('#waktu_potongan_bongkar_gt_04_update').val(parsed.waktu_potongan_bongkar_gt_04_pk);
                    }
                });
            });
        });
