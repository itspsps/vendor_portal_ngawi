                            ...
                            <div class="card">
                                <div class="card-header" id="headingOne4">
                                    <div class="card-title" data-toggle="collapse" data-target="#collapseOne4"
                                        ...
                                        <i class="flaticon-add-circular-button"></i> Tambah Parameter PK (Katul)
                                    </div>
                                </div>
                                <div id="collapseOne4" class="collapse" aria-labelledby="headingOne"
                                    ...
                                    <div class="card-body">
                                        <form class="kt-form" id="kt_apps_user_add_user_form"
                                            action="{{ route('qc.lab.parameter_lab_pk_katul_store') }}" method="post"
                                                            ...
                                                            <div class="col-xl-12">
                                                                <div class="kt-section__body">
                                                                    <div class="form-group row">
                                                                        <label class="col-xl-3 col-lg-3 col-form-label">Min Katul</label>
                                                                        <div class="col-lg-9 col-xl-9">
                                                                            <input type="number" class="form-control" required name="min_parameter_lab_pk_katul">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label class="col-xl-3 col-lg-3 col-form-label">Max Katul</label>
                                                                        <div class="col-lg-9 col-xl-9">
                                                                            <input type="number" class="form-control" required name="max_parameter_lab_pk_katul">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label class="col-xl-3 col-lg-3 col-form-label">Refraksi Katul</label>
                                                                        <div class="col-lg-9 col-xl-9">
                                                                            <input type="text" class="form-control" required name="harga_parameter_lab_pk_katul">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label class="col-xl-3 col-lg-3 col-form-label">Tanggal</label>
                                                                        <div class="col-lg-9 col-xl-9">
                                                                            <input type="date" class="form-control" required name="tanggal_parameter_lab_pk_katul">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form class="m-form m-form--fit m-form--label-align-right" method="post"
                            action="{{ route('qc.lab.parameter_lab_pk_katul_update') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('POST') }}
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <div class="">
                                        <label>Min KA</label>
                                        <input id="min_parameter_lab_pk_katul" required name="min_parameter_lab_pk_katul" placeholder="" type="number" class="form-control m-input">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="">
                                        <label>Max KA</label>
                                        <input id="max_parameter_lab_pk_katul" required name="max_parameter_lab_pk_katul" placeholder="" type="number" class="form-control m-input">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="">
                                        <label>Refraksi Katul</label>
                                        <input id="harga_parameter_lab_pk_katul" required name="harga_parameter_lab_pk_katul" placeholder="" type="number" class="form-control m-input">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('body').on('click', '#btnSave', function() {
                ...
                var min_parameter_lab_pk_katul = $('#min_parameter_lab_pk_katul').val();
                var max_parameter_lab_pk_katul = $('#max_parameter_lab_pk_katul').val();
                var harga_parameter_lab_pk_katul = $('#harga_parameter_lab_pk_katul').val();
                var tanggal_parameter_lab_pk_katul = $('#tanggal_parameter_lab_pk_katul').val();
                $.ajax({
                    data: {
                        min_parameter_lab_pk_katul: min_parameter_lab_pk_katul,
                        max_parameter_lab_pk_katul: max_parameter_lab_pk_katul,
                        harga_parameter_lab_pk_katul: harga_parameter_lab_pk_katul,
                        tanggal_parameter_lab_pk_katul: tanggal_parameter_lab_pk_katul,
                    },
