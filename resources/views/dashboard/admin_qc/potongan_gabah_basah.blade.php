                            ...
                            <div class="card">
                                <div class="card-header" id="headingOne4">
                                    <div class="card-title" data-toggle="collapse" data-target="#collapseOne4"
                                        ...
                                        <i class="flaticon2-add kt-font-info"></i> Tambah Potongan
                                    </div>
                                </div>
                                <div id="collapseOne4" class="collapse" aria-labelledby="headingOne"
                                    data-parent="#accordionExample4">
                                    <div class="card-body">
                                        <form id="formgt04" class="kt-form" id="kt_apps_user_add_user_form"
                                            action="{{ route('qc.lab.store_potongan_gabah_basah') }}" method="post"
                                            ...
                                            <div class="kt-wizard-v4__content" data-ktwizard-type="step-content"
                                                ...
                                                <div class="kt-section kt-section--first">
                                                    ...
                                                    <div class="kt-form__actions">
                                                        <button id="btn_save" type="submit" class="btn btn-success m-btn pull-right"
                                                            style="">Save</button>
                                                    </div><br>
                                                </div>
                                            </div>
            ...
            <div class="modal fade" id="modal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form id="formupdategt04" class="m-form m-form--fit m-form--label-align-right" method="post"
                            action="{{ route('qc.lab.update_potongan_gabah_basah') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('POST') }}
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <div class="">
                                        ...
                                        <input id="potongan_bongkar_gt_04_update" required name="potongan_bongkar_gt_04_update" placeholder="" type="number"
                                ...
                                <div class="form-group">
                                    <div class="">
                                        ...
                                        <input id="transparasi" required name="transparasi" placeholder="" type="number"
                                            class="form-control m-input">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="">
                                        <label>Waktu</label>
                                        <input id="waktu_potongan_bongkar_gt_04_update" required name="waktu_potongan_bongkar_gt_04_update" placeholder="" type="date"
                                            class="form-control m-input">
                                    </div>
                                </div>
    ...
    <script>
        $(function() {
            var table = $('#potongan').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: "{{ route('qc.lab.potongan_gabah_basah_index') }}",
                columns: [{
                        data: "id_harga_bawah",
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#btn_delete', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{url('qc/lab/destroy_potongan_gabah_basah')}}/" + cek,
                        type: "GET",
                        error: function() {
            ...
            $(document).on('click', '.to_potongan_bongkar_gt_04', function() {
                ...
                var url = '{{ route('qc.lab.show_potongan_gabah_basah') }}' + "/" + id;
                console.log(url);
                $.ajax({
                    type: "GET",
                    url: url,
                    success: function(response) {
                        ...
                        $('#id_potongan_bongkar_gt_04_update').val(parsed.id_potongan_bongkar_gt_04_gb);
                        $('#transparasi').val(parsed.transparasi_gb);
                        $('#potongan_bongkar_gt_04_update').val(parsed.potongan_bongkar_gt_04_gb);
                        $('#waktu_potongan_bongkar_gt_04_update').val(parsed.waktu_potongan_bongkar_gt_04_gb);
                    }
                });
            });
        });
