        ...
        <div class="col-xl-12 col-lg-12 col-md-12 order-lg-1 order-xl-1">
            <div class="kt-portlet kt-portlet--mobile">
                ...
                <div class="kt-portlet__body">
                    ...
                    @elseif(Auth::guard('lab')->user()->level=='MANAGER')
                    <table class="table table-bordered" id="table-harga-atas1">
                        <thead>
                            <tr>
                                <th style="text-align: center;width:2%">No</th>
                                <th style="text-align: center;width:auto">Harga Atas</th>
...
<script>
    $(function() {
        var table = $('#table-harga-atas').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('qc.lab.harga_atas_beras_ds_index') }}",
            columns: [{
                    data: "id_bid",
        ...
        var table = $('#table-harga-atas1').DataTable({
            "scrollY": true,
            "scrollX": true,
            processing: true,
            serverSide: true,
                        ...
                        Swal.fire({
                            ...
                            onBeforeOpen: () => {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{route('qc.lab.store_harga_atas_beras_ds')}}",
                                    type: "POST",
                                    dataType: 'json',
                        ...
                        Swal.fire({
                            ...
                            onBeforeOpen: () => {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{route('qc.lab.update_harga_atas_beras_ds')}}",
                                    type: "POST",
                                    dataType: 'json',
                                    success: function(data) {
                                        $('#table-harga-atas').DataTable().ajax.reload();
    ...
    $('body').on('click', '#btn_delete', function() {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "{{url('qc/lab/destroy_harga_atas_beras_ds')}}/" + cek,
                    type: "GET",
                    error: function() {
    ...
    $(document).on('click', '.to_harga_atas', function() {
        ...
        var url = "{{route('qc.lab.show_harga_atas_beras_ds')}}" + "/" + id;
        console.log(url);
        $.ajax({
            type: "GET",
            url: url,
