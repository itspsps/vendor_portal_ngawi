    ...
    $(document).ready(function() {
        ...
        function load_data(from_date = '', to_date = '') {
            var table = $('#data_longgrain').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('qc.lab.data_revisi_gb_longgrain_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            //     "iDisplayLength": 10,
            //     ajax: {
            //         url: "{{ route('qc.lab.data_revisi_gb_ciherang_index') }}",
            //         data: {
            //             from_date: from_date,
            //             to_date: to_date
            //         }
            ...
            var table2 = $('#data_pw').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('qc.lab.data_revisi_gb_pandan_wangi_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table3 = $('#data_kp').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('qc.lab.data_revisi_gb_ketan_putih_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
        ...
        $(document).on('click', '.to_revisibongkar', function() {
            ...
            var url = "{{ route('qc.lab.show_revisi_gb') }}" + "/" + id;
            $.ajax({
                type: "GET",
                url: url,
