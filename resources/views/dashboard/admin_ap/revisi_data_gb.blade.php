        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    <a href="{{route('ap.revisi_data_gb')}}" onclick="return false" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-fast-next"></i></a>
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="{{route('ap.revisi_data_gb')}}" onclick="return false" class="kt-subheader__breadcrumbs-link">
                        Data Revisi
                    </a>
                    <a href="{{route('ap.revisi_data_gb')}}" onclick="return false" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-fast-next"></i></a>
                    <span class="kt-subheader__breadcrumbs-separator"></span>
...
<script>
    $(function() {
        var table = $('#datatable').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('ap.revisi_data_gb_index') }}",
            columns: [{
