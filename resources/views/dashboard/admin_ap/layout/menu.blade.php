    ...
    <ul class="kt-menu__nav ">
      ...
      <li class="kt-menu__item kt-menu__item--submenu {{ Request::is('ap/data_pembelian_gb*') ? 'kt-menu__item--open' : '' }}{{ Request::is('ap/data_pembelian_pk*') ? 'kt-menu__item--open' : '' }}" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
        <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
          ...
          <span id="count_verifikasi" class="badge badge badge-info" style="position:absolute; right: 0%; width: max-content; background-color: green;"><span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
          </span>
        </a>
      ...
      <li class="kt-menu__item kt-menu__item--submenu {{ Request::is('ap/revisi_data_gb*') ? 'kt-menu__item--open' : '' }}{{ Request::is('ap/revisi_data_pk*') ? 'kt-menu__item--open' : '' }}" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
        <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
          ...
          <i class="kt-menu__ver-arrow la la-angle-right"></i>
          <span id="count_revisi" class="badge badge badge-info" style="position:absolute; right: 0%; width: max-content; background-color: green;"><span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
          </span>
        </a>
        <div class="kt-menu__submenu " kt-hidden-height="200" style="">
          <span class="kt-menu__arrow"></span>
      ...
      <li class="kt-menu__item text-center" aria-haspopup="true" data-ktmenu-submenu-toggle="hover" style="bottom: 2%; position: fixed; margin-left: -5px; text-align: center;">
        <div class="kt-menu__link kt-menu__toggle">
          <span class="kt-menu__link-text">
            2023&nbsp;&copy;&nbsp;<a href="https://ngawi.suryapangansemesta.store/ap/home" target="_blank" class="kt-link">VENDOR PORTAL-NGAWI</a>
          </span>
        </div>
      </li>
    </ul>
