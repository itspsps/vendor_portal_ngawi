										...
										<form>
											<div class="tab-content">
                                                ...
                                                <div class="text-center">
                                                    <a href="{{route('ap.get_notif_ap_all')}}"><b>Baca Selengkapnya</b> <i class="flaticon2-right-arrow"></i></a>
                                                </div>
												</div>
											</div>
										</form>
...
<script>
    ...
    function getcount_notifmenuall() {
        $.ajax({
            type: "GET",
            url: "{{route('ap.getcount_notifmenuall')}}",
            success: function(data) {
                ...
                $("#count_revisi").html(notif.data_revisi);
            }
        });
    }
    ...
    setInterval(getcount_notifmenuall, 2000);
