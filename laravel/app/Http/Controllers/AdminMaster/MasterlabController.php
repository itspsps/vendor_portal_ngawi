...
class MasterlabController extends Controller
{
    ...
    {
        return view('dashboard.admin_master.admin_qc.proses_lab1_gabah_basah');
    }

    public function proses_lab1_gabah_kering()
    {
        return view('dashboard.admin_master.admin_qc.proses_lab1_gabah_kering');
    }

    public function proses_lab1_pecah_kulit()
    {
        return view('dashboard.admin_master.admin_qc.proses_lab1_pecah_kulit');
    }

    public function proses_lab1_beras_ds()
    {
        return view('dashboard.admin_master.admin_qc.proses_lab1_beras_ds');
    }

    public function proses_lab2_gabah_basah()
    {
        return view('dashboard.admin_master.admin_qc.proses_lab2_gabah_basah');
    }

    public function proses_lab2_gabah_kering()
    {
        return view('dashboard.admin_master.admin_qc.proses_lab2_gabah_kering');
    }

    public function proses_lab2_pecah_kulit()
    {
        return view('dashboard.admin_master.admin_qc.proses_lab2_pecah_kulit');
    }

    public function proses_lab2_beras_ds()
    {
        return view('dashboard.admin_master.admin_qc.proses_lab2_beras_ds');
    }
    ...
    public function proses_lab2_gabah_basah_ciherang_index()
    {
        ...
        return Datatables::of(DB::table('data_po')->join('bid', 'bid.id_bid', '=', 'data_po.bid_id')
            ...
            ->rawColumns(['kode_po', 'nama_vendor', 'tanggal_po', 'waktu_penerimaan', 'nama_penerima_po', 'plat_kendaraan', 'ckelola', 'detail_hasil_qc'])
            ->make(true);
    }
    ...
    public function save_proseslab1_gabah_basah(Request $request)
    {
        ...
        if ($request->keterangan_lab_1_gb == 'Unload') {
            ...
            $log->nama_user                    = Auth::guard('master')->user()->name_master;
            $log->id_objek_aktivitas_lab       = $data->id_lab1_gb;
            $log->aktivitas_lab                = 'insert LAB 1 Kode PO:' . $request->lab1_kode_po_gb . ' Status : ' . $request->keterangan_lab_1_gb;
            $log->keterangan_aktivitas         = 'Selesai';
            $log->created_at                   = date('Y-m-d H:i:s');
            $log->save();
        } else {
        ...
        $nopol = $request->lab1_plat_gb;
        //tambah notifikasi
        $notif   = new Notif();
        $notif->judul       = "Antrian Masuk";
        $notif->keterangan  = "Ada antrian baru masuk Truk Nopol " . $nopol;
        $notif->status      = 0;
        $notif->notifbaru   = 0;
        $notif->kategori   = 1;
        $notif->nomor_antrian   = $request->antrian;
        $notif->lokasi   = $request->lokasi_gt_gb;
        $notif->save();
    ...
    public function update_proses1_gabah_basah(Request $request)
    {
        ...
        if ($request->keterangan_lab_1 == 'Unload') {
            ...
            $log->nama_user                    = Auth::guard('master')->user()->name_master;
            $log->id_objek_aktivitas_lab       = $data->id_lab1_gb;
            $log->aktivitas_lab                = 'Update LAB 1 Kode PO:' . $data->lab1_kode_po_gb . ' Status : ' . $request->keterangan_lab_1;
            $log->keterangan_aktivitas         = 'Selesai';
            $log->created_at                   = date('Y-m-d H:i:s');
            $log->save();
        } else {
    ...
    {
        return view('dashboard.admin_master.admin_qc.unload_lab1_gabah_basah');
    }
    ...
    {
        return view('dashboard.admin_master.admin_qc.unload_lab1_pecah_kulit');
    }
    ...
    {
        return view('dashboard.admin_master.admin_qc.pending_lab1_gabah_basah');
    }
    ...
    {
        return view('dashboard.admin_master.admin_qc.pending_lab1_pecah_kulit');
    }
    ...
    {
        return view('dashboard.admin_master.admin_qc.reject_lab1_gabah_basah');
    }
    public function reject_lab1_gabah_basah_ciherang_index(Request $request)
    {
        if (request()->ajax()) {
            if (!empty($request->from_date)) {
                return Datatables::of(DB::table('data_po')->join('bid', 'bid.id_bid', '=', 'data_po.bid_id')
    ...
    {
        return view('dashboard.admin_master.admin_qc.reject_lab1_pecah_kulit');
    }
    ...
    public function save_proses_lab2_gb(Request $request)
    {
        ...
        $data->tempat_gb                               = $request->tempat_bongkar;
    ...
    public function save_proses_lab2_pk(Request $request)
    {
        ...
        $update_status_penerimaan_po = DB::table('penerimaan_po')->where('id_penerimaan_po', $request->lab1_id_data_po_pk)->where('penerimaan_kode_po', $request->lab1_kode_po_pk)
    ...
    {
        return view('dashboard.admin_master.admin_qc.output_proses_lab1_gb');
    }

    public function output_proses_lab1_pk()
    {
        return view('dashboard.admin_master.admin_qc.output_proses_lab1_pk');
    }

    public function output_proses_lab2_gb()
    {
        return view('dashboard.admin_master.admin_qc.output_proses_lab2_gb');
    }

    public function output_proses_lab2_pk()
    {
        return view('dashboard.admin_master.admin_qc.output_proses_lab2_pk');
    }

    public function output_deal_lab2_gb()
    {
        return view('dashboard.admin_master.admin_qc.output_deal_lab2_gb');
    }

    public function output_deal_lab2_pk()
    {
        return view('dashboard.admin_master.admin_qc.output_deal_lab2_pk');
    }

    public function output_nego_lab2_gb()
    {
        return view('dashboard.admin_master.admin_qc.output_nego_lab2_gb');
    }

    public function output_nego_lab2_pk()
    {
        return view('dashboard.admin_master.admin_qc.output_nego_lab2_pk');
    }

    public function output_lab1_gb_qc_pandan_wangi_index(Request $request)
    {
        if (request()->ajax()) {
                ...
                return Datatables::of(DB::table('data_po')->join('bid', 'bid.id_bid', '=', 'data_po.bid_id')
                    ...
                    ->addColumn('ckelola_manager', function ($list) {
                        ...
                        <i class="fa fa-credit-card"></i>&nbsp;Pending&nbsp;Harga
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
                                <a class="dropdown-item" href="' . route('master.approve_lab1_qc_gb', ['id' => $list->id_lab1_gb]) . '"  style="color:red"><i class="fas fa-check" style="color:red"></i>Bongkar</a>
                            </div>
                        </div>';
                        }
                    })
    ...
    public function output_lab1_gb_qc_longgrain_index(Request $request)
    {
        if (request()->ajax()) {
    ...
    public function output_lab1_gb_qc_ciherang_index(Request $request)
    {
        return Datatables::of(DB::table('data_po')->join('bid', 'bid.id_bid', '=', 'data_po.bid_id')
            ->join('users', 'users.id', '=', 'data_po.user_idbid')
            ->join('penerimaan_po', 'penerimaan_po.penerimaan_id_data_po', '=', 'data_po.id_data_po')
    ...
    public function output_lab1_gb_qc_ketan_putih_index(Request $request)
    {
        if (request()->ajax()) {
    ...
    public function output_lab1_qc_pk_index(Request $request)
    {
        return Datatables::of(DB::table('data_po')->join('bid', 'bid.id_bid', '=', 'data_po.bid_id')
            ->join('users', 'users.id', '=', 'data_po.user_idbid')
            ->join('penerimaan_po', 'penerimaan_po.penerimaan_id_data_po', '=', 'data_po.id_data_po')
            ...
            ->addColumn('ckelola', function ($list) {
                if ($list->status_lab1_pk == 6) {
                    return
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
							<button class="dropdown-item" id="btn_bongkar" data-id="' . $list->id_lab1_pk . '"><i class="fas fa-check"></i>Bongkar</button>
                    ...
                    return
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
							<a class="dropdown-item" href="' . route('master.approve_lab1_pk', ['id' => $list->id_lab1_pk]) . '"  style="color:red"><i class="fas fa-check" style="color:red"></i>Bongkar</a>
						</div>
					</div>';
                }
            })
    ...
    public function output_gabah_lab2()
    {
        ...
        $harga_atas = DB::table('harga_atas')->orderBy('id_harga_atas', 'desc')->first();
        return view('dashboard.admin_master.admin_qc.output_gabah_lab2', ['plan_hpp_gabah_basah' => $plan_hpp_gabah_basah]);
    }

    public function approve_lab1_qc_gb($id)
    {
    ...
    public function approve_lab1_pk($id)
    {
        ...
        $data                   = DB::table('lab1_pk')->where('id_lab1_pk', $id)->update(['status_lab1_pk' => 7, 'status_approved' => 1]);
    }
    ...
    public function approve_lab2_qc_pk($id)
    {
        $get_kode_po            = DB::table('lab2_pk')->where('id_lab2_pk', $id)->first();
        $update_data_po         = DB::table('data_po')->where('kode_po', $get_kode_po->lab2_kode_po_pk)->update(['status_bid' => 12]);
        $update_pernerimaan_po  = DB::table('penerimaan_po')->where('penerimaan_kode_po', $get_kode_po->lab2_kode_po_pk)->update(['status_penerimaan' => 12]);
    ...
    {
        $data = DB::table('lab2_gb')
            ->join('penerimaan_po', 'penerimaan_po.penerimaan_kode_po', '=', 'lab2_gb.lab2_kode_po_gb')
    ...
    public function approve_lab2_qc_gb($id)
    {

        $get_kode_po            = DB::table('lab2_gb')->where('id_lab2_gb', $id)->first();
        $update_data_po         = DB::table('data_po')->where('kode_po', $get_kode_po->lab2_kode_po_gb)->update(['status_bid' => 12]);
        $update_data_incoming   = DB::table('lab1_gb')->where('lab1_kode_po_gb', $get_kode_po->lab2_kode_po_gb)->update(['status_lab1_gb' => 12]);
        $update_data_finishing  = DB::table('lab2_gb')->where('id_lab2_gb', $id)->update(['status_lab2_gb' => 12, 'status_approved' => 0, 'keterangan_harga_akhir_gb' => 'Harga Sesuai Hasil Lab']);
        $update_pernerimaan_po  = DB::table('penerimaan_po')->where('penerimaan_kode_po', $get_kode_po->lab2_kode_po_gb)->update(['status_penerimaan' => 12]);
    ...
    public function output_lab2_gb_ciherang_qc_index(Request $request)
    {
        if (request()->ajax()) {
    ...
    public function output_lab2_gb_longgrain_qc_index(Request $request)
    {
        if (request()->ajax()) {
            ...
            if (!empty($request->from_date)) {
                return Datatables::of(DB::table('data_po')
                    ...
                    ->rawColumns(['kode_po', 'antrian', 'nama_vendor', 'ckelola_manager', 'status_lab2_gb', 'tanggal_po', 'keterangan_penerimaan_po', 'no_dtm', 'plat_kendaraan', 'hasil_akhir_tonase', 'kadar_air', 'ka_kg', 'berat_sample_awal_ks', 'berat_sample_awal_kg', 'berat_sample_akhir_kg', 'berat_sample_pk', 'berat_sample_beras', 'wh', 'tp', 'md', 'broken_setelah_bongkar', 'hampa', 'kg_after_adjust_hampa', 'prosentasi_kg', 'susut', 'adjust_susut', 'prsentase_ks_kg_after_adjust_susut', 'prsentase_kg_pk', 'adjust_prosentase_kg_pk', 'presentase_ks_pk', 'presentase_putih', 'adjust_prosentase_kg_ke_putih', 'plan_rend_dari_ks_beras', 'katul', 'plan_berat_kg_pertruk', 'plan_berat_pk_pertruk', 'plan_berat_beras_pertruk', 'refraksi_broken', 'plan_harga_gabah', 'plan_harga_beli_gabah', 'harga_berdasarkan_tempat', 'harga_berdasarkan_harga_atas', 'harga_awal', 'aksi_harga', 'reaksi_harga', 'harga_akhir'])
                    ->make(true);
            } else {
                return Datatables::of(DB::table('data_po')
                    ->join('bid', 'bid.id_bid', '=', 'data_po.bid_id')
    ...
    public function output_lab2_gb_pandan_wangi_qc_index(Request $request)
    {
        if (request()->ajax()) {
    ...
    public function output_lab2_gb_ketan_putih_qc_index(Request $request)
    {
        if (request()->ajax()) {
    ...
    public function output_lab2_pk_qc_index(Request $request)
    {
        if (request()->ajax()) {
    ...
    {
        $plan_hpp_gabah_basah = PlanHppGabahBasah::get();
        return view('dashboard.admin_master.admin_qc.finishing_qc', ['plan_hpp_gabah_basah' => $plan_hpp_gabah_basah]);
    }
    ...
    {
        $data = DB::table('lab1_gb')
            ->join('data_qc_bongkar', 'data_qc_bongkar.kode_po_bongkar', '=', 'lab1_gb.lab1_kode_po_gb')
    ...
    {
        return view('dashboard.admin_master.admin_qc.output_gabah_onprocess');
    }
        ...
        if (request()->ajax()) {
            ...
            if (!empty($request->from_date)) {
                return Datatables::of(DB::table('data_po')
                    ...
                    ->rawColumns(['kode_po', 'tonase_awal', 'tonase_akhir', 'nama_vendor', 'status_lab2_gb', 'date_bid', 'keterangan_penerimaan_po', 'no_dtm', 'plat_kendaraan', 'hasil_akhir_tonase', 'kadar_air', 'ka_kg', 'berat_sample_awal_ks', 'berat_sample_awal_kg', 'berat_sample_akhir_kg', 'berat_sample_pk', 'berat_sample_beras', 'wh', 'tp', 'md', 'broken_setelah_bongkar', 'hampa', 'kg_after_adjust_hampa', 'prosentasi_kg', 'susut', 'adjust_susut', 'prsentase_ks_kg_after_adjust_susut', 'prsentase_kg_pk', 'adjust_prosentase_kg_pk', 'presentase_ks_pk', 'presentase_putih', 'adjust_prosentase_kg_ke_putih', 'plan_rend_dari_ks_beras', 'katul', 'plan_berat_kg_pertruk', 'plan_berat_pk_pertruk', 'plan_berat_beras_pertruk', 'refraksi_broken', 'plan_harga_gabah', 'plan_harga_beli_gabah', 'harga_berdasarkan_tempat', 'harga_berdasarkan_harga_atas', 'harga_awal', 'aksi_harga', 'reaksi_harga', 'harga_akhir'])
                    ->make(true);
            } else {
                return Datatables::of(DB::table('data_po')
                    ->join('bid', 'bid.id_bid', '=', 'data_po.bid_id')
                    ...
                    ->rawColumns(['kode_po', 'nama_vendor', 'tonase_awal', 'tonase_akhir', 'status_gabahfinishing_qc', 'date_bid', 'keterangan_penerimaan_po', 'no_dtm', 'plat_kendaraan', 'hasil_akhir_tonase', 'kadar_air', 'ka_kg', 'berat_sample_awal_ks', 'berat_sample_awal_kg', 'berat_sample_akhir_kg', 'berat_sample_pk', 'berat_sample_beras', 'wh', 'tp', 'md', 'broken_setelah_bongkar', 'hampa', 'kg_after_adjust_hampa', 'prosentasi_kg', 'susut', 'adjust_susut', 'prsentase_ks_kg_after_adjust_susut', 'prsentase_kg_pk', 'adjust_prosentase_kg_pk', 'presentase_ks_pk', 'presentase_putih', 'adjust_prosentase_kg_ke_putih', 'plan_rend_dari_ks_beras', 'katul', 'plan_berat_kg_pertruk', 'plan_berat_pk_pertruk', 'plan_berat_beras_pertruk', 'refraksi_broken', 'plan_harga_gabah', 'plan_harga_beli_gabah', 'harga_berdasarkan_tempat', 'harga_berdasarkan_harga_atas', 'harga_awal', 'aksi_harga', 'reaksi_harga', 'harga_akhir'])
                    ->make(true);
            }
        }
    }
    ...
    {
        return view('dashboard.admin_master.admin_qc.output_gabah_unloading_nego');
    }
    ...
    // LOG ACTIVITY ADMIN QC LAB
    public function log_activity_qc()
    {
        return view('dashboard.admin_master.admin_qc.log_activity_qc ');
    }

    public function log_activity_qc_index()
    {
        return Datatables::of(DB::table('log_aktivitas_lab')
            ->orderby('id_aktivitas_lab', 'desc')
            ->get())
