    ...
    <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed " style="background: #9F187C;">
        <div class="kt-header-mobile__logo">
            <a href="demo11/index.html">
                <img alt="Logo" src="{{ asset('/logo.png') }}" height="40px" width="90px">
            </a>
        </div>
                    ...
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-footer__wrapper">
                            <div class="kt-footer__copyright">
                                2022&nbsp;&copy;&nbsp;<a href="http://keenthemes.com/metronic" target="_blank"
                                    class="kt-link">Cv. Sumber Pangan</a>
                            </div>
                        </div>
                    </div>
                </div>
...
@include('administrator.layout.js') @yield('js')
