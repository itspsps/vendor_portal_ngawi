    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                    ...
                    <div class="accordion  accordion-toggle-arrow" id="accordionExample4">
                        <div class="card">
                            ...
                            <div id="collapseOne4" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample4">
                                <div class="card-body">
                                    <form class="kt-form" id="formaddreward" action="{{ route('qc.lab.parameter_lab_pk_reward_hampa_store') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                ...
                <div class="kt-portlet__body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="m_tabs_3_1" role="tabpanel">
                            ...
                            @elseif(Auth::guard('lab')->user()->level=='MANAGER')
                            <table class="table table-bordered" id="table-parameter-lab-ka1">
                                <thead>
                                    <tr>
                                        <th style="text-align: center;width:2%">No</th>
                                        <th style="text-align: center;width:auto">value Kadar Air</th>
                        ...
                        <div class="tab-pane " id="m_tabs_3_2" role="tabpanel">
                            ...
                            @elseif(Auth::guard('lab')->user()->level=='MANAGER')
                            <table class="table table-bordered" id="table-parameter-lab-hampa1">
                                <thead>
                                    <tr>
                                        <th style="text-align: center;width:2%">No</th>
                                        <th style="text-align: center;width:auto">value Hampa</th>
                        ...
                        <div class="tab-pane " id="m_tabs_3_3" role="tabpanel">
                            ...
                            @elseif(Auth::guard('lab')->user()->level=='MANAGER')
                            <table class="table table-bordered" id="table-parameter-lab-tr1">
                                <thead>
                                    <tr>
                                        <th style="text-align: center;width:2%">No</th>
                                        <th style="text-align: center;width:auto">value TR</th>
                        ...
                        <div class="tab-pane " id="m_tabs_3_4" role="tabpanel">
                            ...
                            @elseif(Auth::guard('lab')->user()->level=='MANAGER')
                            <table class="table table-bordered" id="table-parameter-lab-katul1">
                                <thead>
                                    <tr>
                                        <th style="text-align: center;width:2%">No</th>
                                        <th style="text-align: center;width:auto">value Katul</th>
                        ...
                        <div class="tab-pane " id="m_tabs_3_5" role="tabpanel">
                            ...
                            @elseif(Auth::guard('lab')->user()->level=='MANAGER')
                            <table class="table table-bordered" id="table-parameter-lab-butirpatah1">
                                <thead>
                                    <tr>
                                        <th style="text-align: center;width:2%">No</th>
                                        <th style="text-align: center;width:auto">value Butir Patah</th>
        ...
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
            ...
            <div class="modal fade" id="modal_edit_ka" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('qc.lab.parameter_lab_pk_reward_kadar_air_update') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('POST') }}
            ...
            <div class="modal fade" id="modal_edit_hampa" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('qc.lab.parameter_lab_pk_reward_hampa_update') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('POST') }}
                            <div class="modal-header">
            ...
            <div class="modal fade" id="modal_edit_tr" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('qc.lab.parameter_lab_pk_reward_tr_update') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('POST') }}
                            <div class="modal-header">
            ...
            <div class="modal fade" id="modal_edit_katul" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('qc.lab.parameter_lab_pk_reward_katul_update') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('POST') }}
                            <div class="modal-header">
            ...
            <div class="modal fade" id="modal_edit_butirpatah" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('qc.lab.parameter_lab_pk_reward_butir_patah_update') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('POST') }}
                            <div class="modal-header">
...
<script>
    $(function() {
        ...
        var table1 = $('#table-parameter-lab-ka1').DataTable({
            "scrollY": true,
            "scrollX": true,
            processing: true,
            serverSide: true,
        ...
        var table2 = $('#table-parameter-lab-hampa').DataTable({
            "scrollY": true,
            "scrollX": true,
            processing: true,
            serverSide: true,
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('qc.lab.parameter_lab_pk_reward_hampa_index') }}",
            columns: [{
                    data: "id_bid",
        ...
        var table3 = $('#table-parameter-lab-hampa1').DataTable({
            "scrollY": true,
            "scrollX": true,
            processing: true,
            serverSide: true,
        ...
        var table4 = $('#table-parameter-lab-tr').DataTable({
            "scrollY": true,
            "scrollX": true,
            processing: true,
            serverSide: true,
        ...
        var table5 = $('#table-parameter-lab-tr1').DataTable({
            "scrollY": true,
            "scrollX": true,
            processing: true,
            serverSide: true,
        ...
        var table6 = $('#table-parameter-lab-katul').DataTable({
            "scrollY": true,
            "scrollX": true,
            processing: true,
            serverSide: true,
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('qc.lab.parameter_lab_pk_reward_katul_index') }}",
            columns: [{
                    data: "id_bid",
        ...
        var table7 = $('#table-parameter-lab-katul1').DataTable({
            "scrollY": true,
            "scrollX": true,
            processing: true,
            serverSide: true,
        ...
        var table8 = $('#table-parameter-lab-butirpatah').DataTable({
            "scrollY": true,
            "scrollX": true,
            processing: true,
            serverSide: true,
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('qc.lab.parameter_lab_pk_reward_butir_patah_index') }}",
            columns: [{
                    data: "id_bid",
        ...
        var table8 = $('#table-parameter-lab-butirpatah1').DataTable({
            "scrollY": true,
            "scrollX": true,
            processing: true,
            serverSide: true,
...
<script type="text/javascript">
    $(function() {
        ...
        $(document).on('click', '.to_parameter_hampa', function() {
            var id = $(this).attr("name");
            var url = "{{ route('qc.lab.parameter_lab_pk_reward_hampa_show') }}" + "/" + id;
            console.log(url);
            $.ajax({
                type: "GET",
                url: url,
        ...
        $(document).on('click', '.to_parameter_tr', function() {
            var id = $(this).attr("name");
            var url = "{{ route('qc.lab.parameter_lab_pk_reward_tr_show') }}" + "/" + id;
            console.log(url);
            $.ajax({
                type: "GET",
                url: url,
        ...
        $(document).on('click', '.to_parameter_katul', function() {
            var id = $(this).attr("name");
            var url = "{{ route('qc.lab.parameter_lab_pk_reward_katul_show') }}" + "/" + id;
            console.log(url);
            $.ajax({
                type: "GET",
                url: url,
        ...
        $(document).on('click', '.to_parameter_butirpatah', function() {
            var id = $(this).attr("name");
            var url = "{{ route('qc.lab.parameter_lab_pk_reward_butir_patah_show') }}" + "/" + id;
            console.log(url);
            $.ajax({
                type: "GET",
                url: url,
    ...
    $(document).ready(function() {
        ...
        $('body').on('click', '#btn_delete_ka', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{route('qc.lab.parameter_lab_pk_reward_kadar_air_destroy')}}/" + id,
                        type: "GET",
                        error: function() {
                            Swal.fire({
                                title: 'Gagal!',
        ...
        $('body').on('click', '#btn_delete_hampa', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{route('qc.lab.parameter_lab_pk_reward_hampa_destroy')}}/" + id,
                        type: "GET",
                        error: function() {
                            Swal.fire({
                                title: 'Gagal!',
        ...
        $('body').on('click', '#btn_delete_tr', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{route('qc.lab.parameter_lab_pk_reward_tr_destroy')}}/" + id,
                        type: "GET",
                        error: function() {
                            Swal.fire({
                                title: 'Gagal!',
        ...
        $('body').on('click', '#btn_delete_katul', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{route('qc.lab.parameter_lab_pk_reward_katul_destroy')}}/" + id,
                        type: "GET",
                        error: function() {
                            Swal.fire({
                                title: 'Gagal!',
        ...
        $('body').on('click', '#btn_delete_butirpatah', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{route('qc.lab.parameter_lab_pk_reward_butir_patah_destroy')}}/" + id,
                        type: "GET",
                        error: function() {
                            Swal.fire({
                                title: 'Gagal!',
