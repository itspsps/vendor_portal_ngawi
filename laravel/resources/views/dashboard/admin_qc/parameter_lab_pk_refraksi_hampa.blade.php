                            ...
                            <div class="card">
                                <div class="card-header" id="headingOne4">
                                    <div class="card-title" data-toggle="collapse" data-target="#collapseOne4"
                                        ...
                                        <i class="flaticon-add-circular-button"></i> Tambah Parameter PK (Hampa)
                                    </div>
                                </div>
                                <div id="collapseOne4" class="collapse" aria-labelledby="headingOne"
                                    ...
                                    <div class="card-body">
                                        <form class="kt-form" id="kt_apps_user_add_user_form"
                                            action="{{ route('qc.lab.parameter_lab_pk_hampa_store') }}" method="post"
                                                            ...
                                                            <div class="col-xl-12">
                                                                <div class="kt-section__body">
                                                                    <div class="form-group row">
                                                                        <label class="col-xl-3 col-lg-3 col-form-label">Min Hampa</label>
                                                                        <div class="col-lg-9 col-xl-9">
                                                                            <input type="text" class="form-control" required name="min_parameter_lab_pk_hampa">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label class="col-xl-3 col-lg-3 col-form-label">Max hampa</label>
                                                                        <div class="col-lg-9 col-xl-9">
                                                                            <input type="text" class="form-control" required name="max_parameter_lab_pk_hampa">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label class="col-xl-3 col-lg-3 col-form-label">Nilai Refraksi</label>
                                                                        <div class="col-lg-9 col-xl-9">
                                                                            <input type="text" class="form-control" required name="harga_parameter_lab_pk_hampa">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label class="col-xl-3 col-lg-3 col-form-label">Tanggal</label>
                                                                        <div class="col-lg-9 col-xl-9">
                                                                            <input type="date" class="form-control" required name="tanggal_parameter_lab_pk_hampa">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form class="m-form m-form--fit m-form--label-align-right" method="post"
                            action="{{ route('qc.lab.parameter_lab_pk_hampa_update') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('POST') }}
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <div class="">
                                        <label>Tanggal</label>
                                        <input id="tanggal_parameter_lab_pk_hampa" required name="tanggal_parameter_lab_pk_hampa" placeholder="" type="text" class="form-control m-input">
                                    </div>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('body').on('click', '#btnSave', function() {
                ...
                var min_parameter_lab_pk_hampa = $('#min_parameter_lab_pk_hampa').val();
                var max_parameter_lab_pk_hampa = $('#max_parameter_lab_pk_hampa').val();
                var harga_parameter_lab_pk_hampa = $('#harga_parameter_lab_pk_hampa').val();
                var tanggal_parameter_lab_pk_hampa = $('#tanggal_parameter_lab_pk_hampa').val();
                $.ajax({
                    data: {
                        min_parameter_lab_pk_hampa: min_parameter_lab_pk_hampa,
                        max_parameter_lab_pk_hampa: max_parameter_lab_pk_hampa,
                        harga_parameter_lab_pk_hampa: harga_parameter_lab_pk_hampa,
                        tanggal_parameter_lab_pk_hampa: tanggal_parameter_lab_pk_hampa,
                    },
                    url: "{{ route('qc.lab.parameter_lab_pk_hampa_store') }}",
                    type: "POST",
                    dataType: 'json',
