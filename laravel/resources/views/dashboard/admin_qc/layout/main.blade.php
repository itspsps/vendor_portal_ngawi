                            ...
                            <div class="kt-header__topbar-item kt-header__topbar-item--user">
                                <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                                    <span class="kt-header__topbar-welcome kt-visible-desktop"
                                        style="color: white;">{{Auth::guard('lab')->user()->name_qc}} <i class="fa fa-user-circle"></i></span>
                                </div>
                                <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">

                                    <!--begin: Navigation -->
                                    <div class="kt-notification">
                                    <a href="{{route('qc.lab.account_lab')}}" class="kt-notification__item">
                                        ...
                                        <a href="" class="kt-notification__item" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                            ...
                                            <form id="logout-form" action="{{ route('qc.lab.qc_logout') }}" method="POST"
                                                style="display: none;">
                                                {{ csrf_field() }}
                                            </form>
                                    </div>
                ...
                <div class="kt-body kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-grid--stretch"
                    ...
                    <div class="kt-container  kt-container--fluid  kt-grid kt-grid--ver">
                        ...
                        <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop"
                            ...
                            @include('dashboard.admin_qc.layout.menu')
...
<script>
    ...
    function getcountnotif_databongkar(){
        $.ajax({
            type: "GET",
            url: "{{route('qc.lab.getcountnotif_databongkar')}}",
            success: function(data){
                // console.log(data);
                $( "#data_bongkar" ).empty();
                $("#data_sourching_deal").empty();
                var notif = JSON.parse(data);
                $( "#data_bongkar" ).html(notif);
                var notif = JSON.parse(data);
                $("#data_sourching_deal").html(notif);
            }
          });
    }
    function getcountnotif_data_sourching_deal() {
        $.ajax({
                type: "GET",
                url: "{{route('qc.lab.getcountnotif_data_sourching_deal')}}",
                success: function(data) {
                // console.log(data);
                var notif = JSON.parse(data);
            }
    ...
    setInterval(getcountnotif_data_sourching_deal, 2000);
