...
<div class="modal fade" id="to_edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="formeditoutput" class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('qc.lab.update_lab2_pk') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('POST') }}
    ...
    $(document).ready(function() {
        ...
        function load_data(from_date = '', to_date = '') {
            var table = $('#datatable').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('qc.lab.output_lab2_pk_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
