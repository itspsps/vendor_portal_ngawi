            ...
            <form id="form_outputlab2" class="m-form m-form--fit m-form--label-align-right" method="post" action="javascript:void(0);" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="m-form__group form-group">
                        ...
                        <span class="btn btn-label-info btn-sm "><i class="flaticon2-information"></i> Edit Jika No. DTM Salah</span>
                    </div>
                    <div class="m-form__group form-group">
...
<script type="text/javascript">
    $(function() {
        ...
        $(document).on('click', '#btn_update', function(a) {
            ...
            if (status_plan_hpp == '1' && status_harga_atas == '1' && status_harga_bawah == '1') {
                Swal.fire({
                    ...
                    // console.log(result);
                    if (result.value) {
                        if ($('#ka_ks').val() == '' | $('#ka_kg').val() == '' | $('#no_dtm').val() == '' | $('#berat_sample_awal_ks').val() == '' | $('#berat_sample_awal_kg').val() == '' | $('#berat_sample_akhir_kg').val() == '' | $('#berat_sample_pk').val() == '' | $('#berat_sample_beras').val() == '' | $('#wh').val() == '' | $('#tp').val() == '' | $('#md').val() == '' | $('#keterangan_lab_1').val() == '' | $('#broken_setelah_bongkar').val() == '') {
                            Swal.fire({
                                title: 'Maaf !',
        ...
        $(document).on('click', '#btn_edit', function() {
            ...
            var url = "{{ route('qc.lab.edit_lab2_gb') }}" + "/" + id;
