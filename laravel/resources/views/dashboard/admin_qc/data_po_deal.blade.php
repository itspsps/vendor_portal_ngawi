    ...
    $(document).ready(function() {
        ...
        function load_data(from_date = '', to_date = '') {
            var table = $('#data_longgrain').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('qc.lab.data_sourching_deal_gb_longgrain_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table2 = $('#data_pw').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('qc.lab.data_sourching_deal_gb_pandan_wangi_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table3 = $('#data_kp').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('qc.lab.data_sourching_deal_gb_ketan_putih_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table4 = $('#datatable1').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('qc.lab.data_sourching_deal_pk_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
        ...
        $('#btn_export').click(function() {
            ...
            $.ajax({
                ...
                url: "{{route('qc.lab.download_data_sourching_deal_gb_excel')}}",
                type: "POST",
                cache: false,
                xhrFields: {
                    responseType: 'blob'
