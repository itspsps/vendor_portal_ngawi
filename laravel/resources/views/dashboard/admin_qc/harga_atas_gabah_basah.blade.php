...
<script>
    $(function() {
        var table = $('#table-harga-atas').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('qc.lab.harga_atas_gabah_basah_index') }}",
            columns: [{
                    data: "id_bid",
                        ...
                        Swal.fire({
                            ...
                            onBeforeOpen: () => {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{route('qc.lab.store_harga_atas_gabah_basah')}}",
                                    type: "POST",
                                    dataType: 'json',
                        ...
                        Swal.fire({
                            ...
                            onBeforeOpen: () => {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{route('qc.lab.update_harga_atas_gabah_basah')}}",
                                    type: "POST",
                                    dataType: 'json',
                                    success: function(data) {
                                        $('#table-harga-atas').DataTable().ajax.reload();
    ...
    $(document).on('click', '.to_harga_atas', function() {
        ...
        var url = "{{route('qc.lab.show_harga_atas_gabah_basah')}}" + "/" + id;
        console.log(url);
        $.ajax({
            type: "GET",
            url: url,
