        ...
        <div class="modal fade" id="modal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form id="formupdatehargabawah" class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('qc.spv.update_harga_bawah_gabah_basah') }}" enctype="multipart/form-data">
                        @csrf
...
<script>
    $(function() {
        var table = $('#table-harga-bawah').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('qc.spv.harga_bawah_gabah_basah_index') }}",
            columns: [{
                    data: "id_harga_bawah",
...
<script>
                        ...
                        Swal.fire({
                            ...
                            onBeforeOpen: () => {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{route('qc.spv.store_harga_bawah_gabah_basah')}}",
                                    type: "POST",
                                    dataType: 'json',
                        ...
                        Swal.fire({
                            ...
                            onBeforeOpen: () => {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{route('qc.spv.update_harga_bawah_gabah_basah')}}",
                                    type: "POST",
                                    dataType: 'json',
                                    success: function(data) {
                                        $('#table-harga-bawah').DataTable().ajax.reload();
    ...
    $('body').on('click', '#btn_delete', function() {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "{{route('qc.spv.destroy_harga_bawah_gabah_basah')}}/" + cek,
                    type: "GET",
                    error: function() {
    ...
    $(document).on('click', '.to_harga_bawah', function() {
        ...
        var url = "{{route('qc.spv.show_harga_bawah_gabah_basah')}}" + "/" + id;
        // console.log(url);
        $.ajax({
            type: "GET",
            url: url,
