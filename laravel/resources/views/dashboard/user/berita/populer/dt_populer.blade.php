                        ...
                        <article class="single_blog">
                            <figure>
                                <div class="post_header">
                                    <img src="{{asset('img/populer/'.$populer->gambar_populer)}}" width="30%" style="margin-left: 35%;margin-right:35%" alt="">
                                    <h3 class="post_title">{{$populer->judul_populer}}</h3>
                                    <div class="blog_meta">
                                        <span class="author">Posted by : <a href="">admin</a> / </span>
                                        <span class="meta_date">On : <a href="">{{$populer->waktu_populer}}</a> /</span>
                                        <span class="post_category">In : <a href="">CV. Sumber Pangan</a></span>
                                    </div>
                                </div>
                                ...
                                <figcaption class="blog_content">
                                    <div class="post_content">
                                        <p style="text-align: justify">{{$populer->keterangan_populer}}</p>
                                        <blockquote>
