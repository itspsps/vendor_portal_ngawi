                ...
                <div class="col-lg-9 col-md-12">
                    <div class="blog_wrapper mb-60">
                        <div class="blog_header">
                            <h1>Berita Teknologi Inovasi</h1>
                        </div>
                        <div class="blog_wrapper_inner">
                            @foreach ($berita_pangan as $data)
                                <article class="single_blog">
                                    <figure>
                                        <div class="blog_thumb">
                                            <a href="{{route('user.detailberita',['id'=> $data->id_news])}}"><img src="{{asset('img/berita/'.$data->gambar)}}" alt=""></a>
                                        </div>
                                        <figcaption class="blog_content">
                                            <h4 class="post_title"><a href="{{route('user.detailberita',['id'=> $data->id_news])}}">{{$data->judul_berita}}</a></h4>
                                            <div class="blog_meta">
                                                <span class="author">Posted by : <a href="#">CV. Sumber Pangan</a> / </span>
                                                <span class="meta_date">Posted on :  <a href="#">{{$data->waktu}}</a></span>
                                            </div>
                                            <div class="blog_desc">
                                                <p>{{Str::limit($data->isi_berita, 200, $end='.......')}}</p>
                                            </div>
                                            <footer class="btn_more">
                                                <a href="{{route('user.detailberita',['id'=> $data->id_news])}}"> Read more</a>
                                            </footer>
                                        </figcaption>
                                    </figure>
                                </article>
