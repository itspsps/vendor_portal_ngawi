                                ...
                                @foreach ($search as $search)
                                    ...
                                    <figure>
                                        <div class="blog_thumb">
                                            <a href="{{route('user.detailberita',['id' => $search->id_news])}}"><img src="{{asset('img/berita/'.$search->gambar)}}" alt=""></a>
                                        </div>
                                        <figcaption class="blog_content">
                                            <h4 class="post_title"><a href="{{route('user.detailberita',['id' => $search->id_news])}}">{{$search->judul_berita}}</a></h4>
                                            <div class="blog_meta">
                                                <span class="author">Posted by : <a href="">admin</a> / </span>
                                                <span class="meta_date">Posted on :  <a href="">{{$search->waktu}}</a></span>
                                            </div>
                                            <div class="blog_desc">
                                                <p style="text-align: justify">{{Str::limit($search->isi_berita, 200, $end='.......')}}</p>
                                            </div>
                                            <footer class="btn_more">
                                                <a href="{{route('user.detailberita',['id' => $search->id_news])}}"> Read more</a>
                                            </footer>
                                        </figcaption>
                                    </figure>
                                </article>
