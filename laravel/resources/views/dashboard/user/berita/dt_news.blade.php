                    ...
                    @foreach ($data as $item)
                        <div class="col-xs-6 col-sm-6 col-md-6" style="width: 100%">
                            <div class="kt-portlet kt-portlet--height-fluid kt-widget19">
                                <a href="{{url('user/news_detail/'.$item->id_news)}}">
                                    <div class="kt-portlet__body kt-portlet__body--fit kt-portlet__body--unfill">
                                        <div class="kt-widget19__pic kt-portlet-fit--top kt-portlet-fit--sides"
                                            style="min-height: 150px; background-image: url({{ asset('img/berita/' . $item->gambar) }})">
                                        </div>
                                    </div>
                                        ...
                                        <div class="kt-widget19__content">
                                            <div class="kt-widget19__info" style="float: left">
                                                <span class="kt-widget19__time" style="font-size: 10px;">
                                                    <i class='fas fa-money-check-alt'></i> {{$item->judul_berita}}
                                                </span>
                                                <span class="kt-widget19__time" style="font-size: 10px;">
                                                    <i class='fas fa-calendar'></i> {{$item->waktu}}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
