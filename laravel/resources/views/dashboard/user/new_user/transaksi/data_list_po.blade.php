...
@section('back')
<div class="container">
    <a type="button" id="btn_klik" href="{{route('user.new_history')}}" class="btn btn-sm btn-primary-gradient" style="position: absolute; bottom: 0;"><i class="bi bi-arrow-left-circle"></i>&nbsp;Kembali</a>
</div>
    ...
    <div class="container-xxl py-5" id="feature" style="margin-top: -40%;">
        <div class="container py-5 px-lg-5">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h5 class="text-primary-gradient fw-medium mb-5">DAFTAR LIST PO</h5>
            </div>
            <div class="row g-4">
                @if($data=='[]')
                        ...
                        <div class="position-relative rounded pt-5 pb-4 px-4" style="background-color: #fed1d1;">
                            ...
                            <div class="position-relative bg-light rounded pt-5 pb-4 px-4">
                                ...
                                <dl class="dl-horizontal row" style="font-size: smaller;">
                                    ...
                                    <dd class="col-1">:</dd>
                                    <dd class="col-8" style="font-weight: bold;">SUBANG</dd>
                                    ...
                                    <dd class="col-8" style="font-weight: bold;">
                                        ...
                                        <a id="btn_pengiriman" name="{{$data->kode_po}}" title="Proses Pengiriman" class="btn btn-warning btn-sm">
                                            <i class="bi bi-truck"></i><span>&nbsp;Proses&nbsp;Pengiriman</span>
                                        </a>
                                        ...
                                        <a id="btn_pembayaran" name="{{$data->kode_po}}" title="Pembayaran" class="toshow btn btn-success btn-sm">
                                            <i class="bi-cash-stack"></i><span>&nbsp;Pembayaran</span>
                                        </a>
