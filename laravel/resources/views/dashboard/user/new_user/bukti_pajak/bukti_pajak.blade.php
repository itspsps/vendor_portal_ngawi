    ...
    <div class="container-xxl py-5" id="feature" style="margin-top: -40%;">
        <div class="container py-5 px-lg-5">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h5 class="text-primary-gradient fw-medium mb-5">BUKTI POTONG PAJAK</h5>
            </div>
            <div class="row g-4">
                @if($broadcaster=='[]')
                                    ...
                                    <div class="chat-message-left ">
                                        <div class="dashboard_tab_button h-100">
                                            <ul role="tablist" class="nav flex-column dashboard-list">
                                                ...
                                                <li>
                                                    <a href="#notif{{ $data->id_potong_pajak }}" data-bs-toggle="tab" class="nav-link {{ $firsttabs == $data->id_potong_pajak ? 'active' : '' }}">
                                        ...
                                        <div class="tab-content dashboard_content w-100">
                                            @foreach($broadcaster as $data)
                                            <div class="tab-pane {{ $firsttabs == $data->id_potong_pajak ? 'active' : 'fade' }}" id="notif{{ $data->id_potong_pajak }}">
                                                <div class="flex-shrink-1 bg-light rounded py-2 px-3">
                                                    ...
                                                    <br>
                                                    <a href="https://subang.suryapangansemesta.store/public/dokumen/potong_pajak/{{$data->file_potong_pajak}}" class="btn btn-sm btn-info"> DOWNLOAD</a>
