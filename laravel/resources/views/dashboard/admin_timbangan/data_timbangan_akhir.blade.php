    ...
    $(document).ready(function() {
        ...
        function load_data(from_date = '', to_date = '') {
            var table = $('#data_longgrain').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('timbangan.data_timbangan_akhir_gb_longgrain_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table2 = $('#data_pw').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('timbangan.data_timbangan_akhir_gb_pandan_wangi_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table3 = $('#data_kp').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('timbangan.data_timbangan_akhir_gb_ketan_putih_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table4 = $('#datatable1').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('timbangan.data_timbangan_akhir_pk_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
        ...
        $('#btn_export').click(function() {
            ...
            $.ajax({
                ...
                url: "{{route('timbangan.download_excel')}}",
                type: "POST",
                cache: false,
                xhrFields: {
                    responseType: 'blob'
        ...
        $('#btn_export1').click(function() {
            ...
            $.ajax({
                ...
                url: "{{route('timbangan.download_penerimaan_barang_excel')}}",
                type: "POST",
                cache: false,
                xhrFields: {
                    responseType: 'blob'
...
<script type="text/javascript">
    $(function() {
        ...
        $(document).on('click', '#btn_cek', function() {
            ...
            $.ajax({
                type: "GET",
                url: "{{route('timbangan.total_tonase')}}",
                data: {
                    "_token": "{{ csrf_token() }}",
