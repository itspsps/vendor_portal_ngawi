            ...
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        <a href="#" onclick="return false" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter kt-font-primary"></i></a>
                        <span class="kt-subheader__breadcrumbs-separator"></span>
                        <a href="{{route('timbangan.home')}}" onclick="return false" class="kt-subheader__breadcrumbs-link">
                           SURYA PANGAN SEMESTA </a>
                                ...
                                <div class="kt-portlet__body kt-portlet__body--fluid">
                                    <div class="kt-widget26">
                                        <div class="kt-widget26__content">
                                            <span class="kt-widget26__number"><i class="flaticon-users-1 kt-font-primary"></i>
                                                    <span class="btn-outline btn-sm btn-info">Site Ngawi</span>
                                            </span>
                                            <span class="kt-widget26__desc">Welcome {{Auth::user()->name_admin_timbangan}}
                                            </span>
                                        </div>
