    ...
    <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed " style="background: #9F187C;">
        <div class="kt-header-mobile__logo">
            <a href="{{route('qc.bongkar.home')}}">
                <h5 class="kt-font" style="color:white">PT. SPS</h5>
            </a>
        </div>
                    ...
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-footer__wrapper">
                            <div class="kt-footer__copyright">
                                2022&nbsp;&copy;&nbsp;<a href="http://keenthemes.com/metronic" target="_blank" class="kt-link">PT. SURYA PANGAN SEMESTA</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            success: function(data) {
                ...
                if (panjang > 0) {
                    for (var a = 0; a < panjang; a++) {
                        //desain notif
                        var idnotif = data.get_notifikasibongkar[a].id_notifikasi;
                        var not = '<a href="{{route('qc.bongkar.set_notifikasibongkar')}}?id=' + idnotif + '" class="kt-notification__item"><span class="mt--10 mr-2 btn btn-label-primary btn-sm btn-bold btn-font-md">No.</br> ' + data.get_notifikasibongkar[a].no_antrian + '</span><div class="kt-notification__item-details"><div class="kt-notification__item-title">' + data.get_notifikasibongkar[a].judul + ' <span class="btn btn-label-success btn-sm ">' + data.get_notifikasibongkar[a].created_at + '</span></div><div class="kt-notification__item-time">' + data.get_notifikasibongkar[a].keterangan + '<br><br></div></div></div></a>';
