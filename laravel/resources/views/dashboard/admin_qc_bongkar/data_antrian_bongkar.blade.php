...
<script>
    $(function() {
        var table2 = $('#data_pw').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('qc.bongkar.data_antrian_bongkar_pandan_wangi_index') }}",
            columns: [{
        ...
        var table3 = $('#data_kp').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('qc.bongkar.data_antrian_bongkar_ketan_putih_index') }}",
            columns: [{
                    data: "id_admin_qc_bongkar",
        ...
        var table4 = $('#data_pk').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('qc.bongkar.data_antrian_bongkar_pk_index') }}",
            columns: [{
                    data: "id_admin_qc_bongkar",
        ...
        var table5 = $('#data_longgrain').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('qc.bongkar.data_antrian_bongkar_longgrain_index') }}",
            columns: [{
                    data: "id_admin_qc_bongkar",
    ...
    $(function() {
        $('body').on('click', '#btn_panggil_gb', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{route('qc.bongkar.data_antrian_bongkar_panggil_gb')}}/" + cek,
                        type: "GET",
                        error: function() {
        ...
        $('body').on('click', '#btn_panggil_pk', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{route('qc.bongkar.data_antrian_bongkar_panggil_pk')}}/" + cek,
                        type: "GET",
                        error: function() {
                            alert('Something is wrong');
                        },
