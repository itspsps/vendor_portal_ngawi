    ...
    $(document).ready(function() {
        ...
        function load_data(from_date = '', to_date = '') {
            var table = $('#data_longgrain').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('sourching.data_sourching_nego_gb_longgrain_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            //     "iDisplayLength": 10,
            //     ajax: {
            //         url: "{{ route('sourching.data_sourching_nego_gb_ciherang_index') }}",
            //         data: {
            //             from_date: from_date,
            //             to_date: to_date
            //         }
            ...
            var table2 = $('#data_pw').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('sourching.data_sourching_nego_gb_pandan_wangi_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var tabl3 = $('#data_kp').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('sourching.data_sourching_nego_gb_ketan_putih_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table4 = $('#datatable1').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('sourching.data_sourching_nego_pk_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
