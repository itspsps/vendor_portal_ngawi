        ...
        <div class="col-xl-12 col-lg-12 col-md-12 order-lg-1 order-xl-1">
            <div class="kt-portlet kt-portlet--mobile">
                ...
                <div class="kt-portlet__body">
                    <table class="table table-bordered" id="data_revisi">
                        <thead>
                            <tr>
...
<div class="modal fade" id="modal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="formupdatenopol" class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('security.update_nopol') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('POST') }}
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="">
                            <label>Nopol</label>
                            <input id="plat_kendaraan" required name="plat_kendaraan" placeholder="" type="text" class="form-control m-input">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" id="btn_update" class="btn btn-success m-btn pull-right">Update</button>
                    </div>
            </form>
        </div>
    </div>
...
<script>
    $(function() {
        var table = $('#data_revisi').DataTable({
            "scrollY": true,
            "scrollX": true,
            processing: true,
            serverSide: true,
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('security.data_revisi_index') }}",
            columns: [{
                    data: "id_bid",
