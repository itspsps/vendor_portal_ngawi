        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <a href="{{route('ap.spv.home')}}" class="kt-subheader__breadcrumbs-link">
                        SURYA PANGAN SEMESTA
                    </a>
            ...
            <div class="kt-portlet kt-portlet--mobile">
                ...
                <form method="post" id="form_account" action="javascript:void(0);" enctype="multipart/form-data">
                    ...
                    <div class="kt-portlet__body">
                        <input type="hidden" name="id" id="id" value="{{$data->id_spv_ap}}">
                        <div class="form-group m-form__group row">
                            <label class="col-xl-3 col-lg-3 col-form-label">* Nama:</label>
                            <div class="col-xl-9 col-lg-9">
                                <input type="text" id="name_spv_ap" name="name_spv_ap" class="form-control m-input" value="{{$data->name_spv_ap}}">
                            </div>
                        </div>
                        <div class="form-group m-form__group row">
                            <label class="col-xl-3 col-lg-3 col-form-label">* Username:</label>
                            <div class="col-xl-9 col-lg-9">
                                <input type="text" id="username_spv_ap" name="username_spv_ap" class="form-control m-input" value="{{$data->username}}">
                            </div>
                        </div>
                        <div class="form-group m-form__group row">
                            <label class="col-xl-3 col-lg-3 col-form-label">* Email:</label>
                            <div class="col-xl-9 col-lg-9">
                                <input type="text" id="email_spv_ap" name="email_spv_ap" class="form-control m-input" value="{{$data->email}}">
                            </div>
                        </div>
                        <div class="form-group m-form__group row">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-xl-9 col-lg-9">
                                <input type="text" id="phone_spv_ap" name="phone_spv_ap" class="form-control m-input" value="{{$data->phone_spv_ap}}">
                            </div>
                        </div>
                        <div class="form-group m-form__group row">
                            <label class="col-xl-3 col-lg-3 col-form-label">* Perusahan:</label>
                            <div class="col-xl-9 col-lg-9">
                                <input type="text" id="company_spv_ap" name="company_spv_ap" class="form-control m-input" value="{{$data->perusahaan}}">
                            </div>
                        </div>
                        <div class="form-group m-form__group row">
                            <label class="col-xl-3 col-lg-3 col-form-label">* Site:</label>
                            <div class="col-xl-9 col-lg-9">
                                <input type="text" class="form-control m-input" readonly value="{{$data->site_spv_ap}}">
                            </div>
                        </div>
                        <div class="form-group m-form__group row">
...
<script type="text/javascript">
    $(function() {
        $('body').on('click', '#btn_update', function() {
            ...
            var id = $('#id').val();
            var name_spv_ap = $('#name_spv_ap').val();
            var username_spv_ap = $('#username_spv_ap').val();
            var email_spv_ap = $('#email_spv_ap').val();
            var password = $('#password').val();
            var phone_spv_ap = $('#phone_spv_ap').val();
            var company_spv_ap = $('#company_spv_ap').val();
            ...
            Swal.fire({
                ...
                if ($('#name_spv_ap').val() == '' || $('username_spv_ap').val() == '' || $('#email_spv_ap').val() == '' || $('#password').val() == '' || $('#company_spv_ap').val() == '' || $('#phone_spv_ap').val() == '') {
                    Swal.fire({
                        title: 'Info !!',
                            ...
                            onBeforeOpen: () => {
                                ...
                                $.ajax({
                                    data: {
                                        "_token": "{{ csrf_token() }}",
                                        id: id,
                                        name_spv_ap: name_spv_ap,
                                        username_spv_ap: username_spv_ap,
                                        email_spv_ap: email_spv_ap,
                                        password: password,
                                        phone_spv_ap: phone_spv_ap,
                                        company_spv_ap: company_spv_ap,
                                        created_at: created_at,
                                        updated_at: updated_at,
                                    },
                                    url: "{{ route('ap.spv.account_update') }}",
                                    type: "POST",
                                    dataType: 'json',
