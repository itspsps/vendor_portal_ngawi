                    ...
                    <div class="accordion  accordion-toggle-arrow" id="accordionExample4">
                        <div class="card">
                            ...
                            <div id="collapseOne4" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample4">
                                <div class="card-body">
                                    <form id="formhargaatas" class="kt-form" action="{{ route('master.store_harga_atas_pecah_kulit') }}" method="post" enctype="multipart/form-data">
                                        @csrf
        ...
        <div class="modal fade" id="modal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form id="formupdatehargaatas" class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('master.update_harga_atas_pecah_kulit') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('POST') }}
...
<script>
    $(function() {
        var table = $('#table-harga-atas').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.harga_atas_pecah_kulit_index') }}",
            columns: [{
                    data: "id_bid",
    ...
    $(function() {
        ...
        $('body').on('click', '#btn_delete', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{url('qc/spv/destroy_harga_atas_pecah_kulit')}}/" + cek,
                        type: "GET",
                        error: function() {
        ...
        $(document).on('click', '.to_harga_atas', function() {
            ...
            var url = "{{ route('master.show_harga_atas_pecah_kulit') }}" + "/" + id;
            console.log(url);
            $.ajax({
                type: "GET",
                url: url,
