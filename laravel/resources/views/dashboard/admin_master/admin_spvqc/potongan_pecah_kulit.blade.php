                    ...
                    <div class="accordion  accordion-toggle-arrow" id="accordionExample4">
                        <div class="card">
                            ...
                            <div id="collapseOne4" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample4">
                                <div class="card-body">
                                    <form id="formgt04" class="kt-form" id="kt_apps_user_add_user_form" action="{{ route('master.store_potongan_pecah_kulit') }}" method="post" enctype="multipart/form-data">
                                        @csrf
        ...
        <div class="modal fade" id="modal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form id="formupdategt04" class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('master.update_potongan_pecah_kulit') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('POST') }}
...
<script>
    $(function() {
        var table = $('#potongan').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.potongan_pecah_kulit_index') }}",
            columns: [{
                    data: "id_harga_bawah",
    ...
    $(function() {
        ...
        $('body').on('click', '#btn_delete', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{url('qc/spv/destroy_potongan_pecah_kulit')}}/" + cek,
                        type: "GET",
                        error: function() {
