...
<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="modal fade" id="modaloutputnegopk" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form id="form_resultnegopk" class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('master.output_nego_pk') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('POST') }}
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Output Nego</h5>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var table = $('#data_longgrain').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.nego_gb_longgrain_index') }}",
            columns: [{
                    data: "id_bid",
        ...
        var table2 = $('#data_pw').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.nego_gb_pandan_wangi_index') }}",
            columns: [{
                    data: "id_bid",
        ...
        var table3 = $('#data_kp').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.nego_gb_ketan_putih_index') }}",
            columns: [{
                    data: "id_bid",
                        ...
                        Swal.fire({
                            ...
                            onBeforeOpen: () => {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{route('master.output_nego_gb')}}",
                                    type: "POST",
                                    dataType: 'json',
