                    ...
                    <div class="accordion  accordion-toggle-arrow" id="accordionExample4">
                        <div class="card">
                            ...
                            <div id="collapseOne4" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample4">
                                <div class="card-body">
                                    <form class="kt-form" id="kt_apps_user_add_user_form" action="{{ route('master.bid_store') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                                        ...
                                                        <div class="col-xl-12">
                                                            <div class="kt-section__body">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        <input class="form-control" required name="image_bid" id="image_bid" placeholder="" accept="image/*" type="file">
        ...
        <div class="modal fade" id="modal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form id="kt_apps_user_update_user_form" class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('master.bid_update') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('POST') }}
                ...
                if (result.value) {
                    Swal.fire({
                        ...
                        onBeforeOpen: () => {
                            Swal.showLoading()
                            $.ajax({
                                url: "{{url('master/bid_destroy')}}/" + cek,
                                type: "GET",
                                error: function() {
                                    Swal.fire({
                                        title: 'Gagal!',
