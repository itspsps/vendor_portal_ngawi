                                                    ...
                                                    <a style="margin:2px;" name="{{ $item_response->id_biduser }}" data-toggle="modal" data-target="#modal1" title="Approved" class="tofinish btn btn-outline-success m-btn m-btn--icon btn-sm m-btn--icon-only">
                                                        ...
                                                        <a style="margin:2px;" data-toggle="modal" data-target="#" title="Approve/Disprove" class="toedit btn btn-outline-info m-btn m-btn--icon btn-sm m-btn--icon-only">
                                                            ...
                                                            <a style="margin:2px;" data-toggle="modal" data-target="#" title="Delivered" class="toedit btn btn-outline-info m-btn m-btn--icon btn-sm m-btn--icon-only">
                                                                ...
                                                                @else
                                                                <a href="{{ route('master.transaction') }}" style="margin:2px;" name="" title="Data Transaksi" class="btn btn-outline-info m-btn m-btn--icon btn-sm m-btn--icon-only">
                                        ...
                                        <div class="modal fade" id="modal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{ route('master.approve_bid') }}" enctype="multipart/form-data">
                                                        {{ csrf_field() }}
                                                        {{ method_field('POST') }}
                                                ...
                                                <a style="margin:2px;" name="{{ $item_response->id_biduser }}" data-toggle="modal" data-target="#modal2" title="Approve/Disapprove" class="toapprove btn btn-outline-info m-btn m-btn--icon btn-sm m-btn--icon-only">
                                                    ...
                                                    <a style="margin:2px;" name="{{ $item_response->id_biduser }}" data-toggle="modal" data-target="#modal1" title="Approved" class="tofinish btn btn-outline-success m-btn m-btn--icon btn-sm m-btn--icon-only">
                                                        ...
                                                        <a style="margin:2px;" data-toggle="modal" data-target="#" title="Approve/Disprove" class="toedit btn btn-outline-danger m-btn m-btn--icon btn-sm m-btn--icon-only">
                                                            ...
                                                            Disapproved
                                                            @else
                                                            <a href="{{ route('master.transaction') }}" style="margin:2px;" name="" title="Data Transaksi" class="btn btn-outline-success m-btn m-btn--icon btn-sm m-btn--icon-only">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                {{-- <form class="m-form m-form--fit m-form--label-align-right" method="post"
                    action="{{ route('master.approve_bid') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('POST') }} --}}
                {{-- <div class="modal-header">
            ...
            <div id="credit-card">
                <header>
                    <span class="title" style="background-image: url('images/fethrpowered.png');"><strong>E-Procurement: </strong>SURYA PANGAN SEMESTA</span><span class="btn-outline btn-sm btn-info">Site Ngawi</span>
                </header>
                <section id="content">
                    <div class="alert alert-success" role="alert">
                        <strong><i class="fa fa-exclamation-triangle"></i>Batas Kapasitas ! </strong> &nbsp; {{$kuota_sisa}} Kg, balance {{$kuota_sisa/8000}} truck
                    </div>
                    <br>
                    ...
                    <form method="post" id="setujuisemua" action="{{route('master.approve_bid') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('POST') }}
                    ...
                    <form method="POST" id="disetujuisebagian" action="{{route('master.approve_bid') }}" enctype="multipart/form-data">
                        @csrf
                        {{ csrf_field() }}
                        {{ method_field('POST') }}
                        <div class="table form-fields">
                    ...
                    <form method="post" id="tidakdisetujui" action="{{route('master.approve_bid') }}" enctype="multipart/form-data">
                        @csrf
                        {{ csrf_field() }}
                        {{ method_field('POST') }}
                        <div class="table form-fields">
