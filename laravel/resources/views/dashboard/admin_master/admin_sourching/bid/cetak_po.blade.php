                        ...
                        <table class="table1 mt--3" align="left">
                            <tr>
                                ...
                                <td align="left" style="vertical-align:top;">
                                    ...
                                    <p style="font-size: 12px; margin-top: -4px;">JL. RAYA NGAWI MADIUN KM 13 TAMBAKROMO KECAMATAN GENENG<br>KAB. NGAWI JAWA TIMUR 63271 <br>INDONESIA</p>
                                </td>
                                <td width="4"></td>
                                <hr>
                            </tr>
                        ...
                        <tr>
                            ...
                            <td width="40%" style="text-align: center; vertical-align:top">
                                <div class="text-center">
                                    ...
                                    <!-- <img style="text-align: center;" src="data:image/png;base64, {{ base64_encode(QrCode::format('png')->size(100)->generate('https://ngawi.suryapangansemesta.store/security/generate/'.$data->id_data_po)) }} "> -->
