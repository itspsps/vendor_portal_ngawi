                ...
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            LOG ACTIVITY ADMIN BONGKAR
                        </h3>
                    </div>
                </div>
                <div class="kt-portlet__body">
                    <table class="table table-bordered" id="data_log_activity_bongkar">
                        <thead>
                            <tr>
...
<script>
    $(function() {
        var table = $('#data_log_activity_bongkar').DataTable({
            "scrollY": true,
            "scrollX": true,
            processing: true,
            serverSide: true,
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.log_activity_qc_bongkar_index') }}",
            columns: [{
                    data: "id_aktivitas_qc",
