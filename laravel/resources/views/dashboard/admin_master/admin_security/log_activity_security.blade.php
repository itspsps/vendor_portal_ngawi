        ...
        <div class="col-xl-12 col-lg-12 col-md-12 order-lg-1 order-xl-1">
            <div class="kt-portlet kt-portlet--mobile">
                ...
                <div class="kt-portlet__body">
                    <table class="table table-bordered" id="data_log_activity_security">
                        <thead>
                            <tr>
...
<script>
    $(function() {
        var table = $('#data_log_activity_security').DataTable({
            "scrollY": true,
            "scrollX": true,
            processing: true,
            serverSide: true,
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.log_activity_security_index') }}",
            columns: [{
