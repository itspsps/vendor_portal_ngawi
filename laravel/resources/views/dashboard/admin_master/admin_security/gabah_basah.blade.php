                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="">
                            ...
                            <input id="name_bid" readonly value="{{Auth::user()->name_master}}" type="text" class="form-control m-input">
                            <input type="hidden" required name="penerima_po" id="penerima_po" value="{{Auth::user()->id_admin_master}}">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="">
...
<div class="modal fade" id="modal_po_ditolak" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="form_poTerlambat" class="m-form m-form--fit m-form--label-align-right" method="post" action="{{route('master.terima_data_po_telat')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('POST') }}
                <div class="modal-header">
...
<div class="modal fade" id="modal_po_diterima" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{route('master.terima_data_po')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('POST') }}
                <div class="modal-header">
...
<script>
    ...
    $(function() {
        var table1 = $('#po_kemarin').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.gabahbasah_index_kemarin') }}",
            columns: [{
                    data: "id_bid",
        ...
        var table2 = $('#datatable_sekarang').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.gabahbasah_index_sekarang') }}",
            columns: [{
                    data: "id_bid",
        ...
        var table3 = $('#data_po').DataTable({
            ...
            "iDisplayLength": 10,
            ajax: "{{ route('master.gabahbasah_index_besok') }}",
            columns: [{
                    data: "id_bid",
...
<script type="text/javascript">
    $(function() {
        $(document).on('click', '.toedit', function() {
            ...
            var url = "{{ route('master.show.penerimaan_po') }}" + "/" + id;
            // console.log(url);
            $.ajax({
                type: "GET",
                url: url,
                        ...
                        Swal.fire({
                            ...
                            onBeforeOpen: () => {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{route('master.terima_data_po')}}",
                                    type: "POST",
                                    dataType: 'json',
