    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="col-xl-12 col-lg-12 col-md-12 order-lg-1 order-xl-1">
            <div class="kt-portlet kt-portlet--mobile">
                ...
                <form class="" method="post" action="{{route('master.download_data_unload_excel')}}" enctype="multipart/form-data">
    ...
    $(document).ready(function() {
        ...
        function load_data(from_date = '', to_date = '') {
            var table = $('#datatable_pk').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('master.unload_lab1_pecah_kulit_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
        ...
        $('#filter').click(function() {
            ...
            if (from_date != '' && to_date != '') {
                $('#datatable_pk').DataTable().destroy();
