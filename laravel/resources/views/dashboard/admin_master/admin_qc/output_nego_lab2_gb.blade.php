    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="col-xl-12 col-lg-12 col-md-12 order-lg-1 order-xl-1">
            <div class="kt-portlet kt-portlet--mobile">
                ...
                <form class="" method="post" action="{{route('master.download_nego_lab2_excel')}}" enctype="multipart/form-data">
    ...
    $(document).ready(function() {
        ...
        function load_data(from_date = '', to_date = '') {
            var table1 = $('#data_longgrain').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('master.output_gabah_longgrain_nego_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table2 = $('#data_pw').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('master.output_gabah_pandan_wangi_nego_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table3 = $('#data_kp').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('master.output_gabah_ketan_putih_nego_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
...
<script type="text/javascript">
    $(function() {
        ...
        $(document).on('click', '.output_nego', function() {
            ...
            var url = "{{ route('master.show_output_nego') }}" + "/" + id;
            console.log(url);
            $.ajax({
                type: "GET",
                url: url,
