    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="col-xl-12 col-lg-12 col-md-12 order-lg-1 order-xl-1">
            <div class="kt-portlet kt-portlet--mobile">
                ...
                <form class="" method="post" action="{{route('master.download_data_reject_excel')}}" enctype="multipart/form-data">
                ...
                <div class="kt-portlet__body">
                    <ul class="nav nav-pills" role="tablist">
                        <li class="nav-item mt-3">
                            <a class="nav-link active" data-toggle="tab" href="#m_tabs_3_1"><i class="la la-database"></i>GABAH BASAH CIHERANG</a>
                        </li>
                        <li class="nav-item mt-3">
    ...
    $(document).ready(function() {
        ...
        function load_data(from_date = '', to_date = '') {
            var table1 = $('#data_ciherang').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('master.reject_lab1_gabah_basah_ciherang_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table2 = $('#data_pw').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('master.reject_lab1_gabah_basah_pandan_wangi_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
            ...
            var table3 = $('#data_kp').DataTable({
                ...
                "iDisplayLength": 10,
                ajax: {
                    url: "{{ route('master.reject_lab1_gabah_basah_ketan_putih_index') }}",
                    data: {
                        from_date: from_date,
                        to_date: to_date
                    }
