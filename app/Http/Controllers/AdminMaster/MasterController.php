...
class MasterController extends Controller
{
    ...
    public function account_update(Request $request)
    {
        ...
        $rules = [
            ...
            'name_master'                     => 'required|max:255',
            'username_master'                 => 'required',
            'email_master'                    => 'required|max:255',
            'company_master'                      => 'required|max:255',
        ...
        $data = AdminMaster::where('id', $request->id)->first();
        // dd($data);
        $data->name_master = $validatedData['name_master'];
        $data->username = $validatedData['username_master'];
        $data->email = $validatedData['email_master'];
        $data->password_show = $validatedData['password'];
        $data->password = Hash::make($request['password']);
        $data->perusahaan = $validatedData['company_master'];
    ...
    {
        $get_notifdatapembelian = DataPO::Join('bid', 'bid.id_bid', '=', 'data_po.bid_id')
            ...
            ->count();
        $get_notifdatarevisiap = DataPO::Join('bid', 'bid.id_bid', '=', 'data_po.bid_id')
            ->join('users', 'users.id', '=', 'data_po.user_idbid')
            ->join('penerimaan_po', 'penerimaan_po.penerimaan_id_data_po', '=', 'data_po.id_data_po')
            ->join('admins', 'admins.id', '=', 'penerimaan_po.penerima_po')
            ->join('lab2_gb', 'lab2_gb.lab2_kode_po_gb', '=', 'data_po.kode_po')
        ...
        $get_notifrevisispvap = DataPO::Join('bid', 'bid.id_bid', '=', 'data_po.bid_id')
            ->join('users', 'users.id', '=', 'data_po.user_idbid')
            ->join('penerimaan_po', 'penerimaan_po.penerimaan_id_data_po', '=', 'data_po.id_data_po')
            ->join('admins', 'admins.id', '=', 'penerimaan_po.penerima_po')
            ->join('lab2_gb', 'lab2_gb.lab2_kode_po_gb', '=', 'data_po.kode_po')
        ...
        $get_notifapprovespvap = DataPO::Join('bid', 'bid.id_bid', '=', 'data_po.bid_id')
            ->join('users', 'users.id', '=', 'data_po.user_idbid')
            ->join('penerimaan_po', 'penerimaan_po.penerimaan_id_data_po', '=', 'data_po.id_data_po')
            ->join('admins', 'admins.id', '=', 'penerimaan_po.penerima_po')
            ->join('lab2_gb', 'lab2_gb.lab2_kode_po_gb', '=', 'data_po.kode_po')
        ...
        $getcountnotif_datatonaseawal = DataPO::join('bid', 'bid.id_bid', '=', 'data_po.bid_id')
            ...
            ->count();
        $get_tonaseakhir = DataPO::join('bid', 'bid.id_bid', '=', 'data_po.bid_id')
            ->join('users', 'users.id', '=', 'data_po.user_idbid')
            ->join('penerimaan_po', 'penerimaan_po.penerimaan_id_data_po', '=', 'data_po.id_data_po')
            ...
            ->where('bid.name_bid', '=', 'GABAH BASAH LONG GRAIN')
            ->count();
        $get_datatonaseakhir = DataPO::join('bid', 'bid.id_bid', '=', 'data_po.bid_id')
            ->join('users', 'users.id', '=', 'data_po.user_idbid')
            ->join('penerimaan_po', 'penerimaan_po.penerimaan_id_data_po', '=', 'data_po.id_data_po')
            ->join('data_qc_bongkar', 'data_qc_bongkar.kode_po_bongkar', '=', 'data_po.kode_po')
            ->where('data_qc_bongkar.status_bongkar', 'FINISH')
            ->where('penerimaan_po.tonase_akhir', '!=', NULL)
            ->count();
        $get_revisitonase = DataPO::join('bid', 'bid.id_bid', '=', 'data_po.bid_id')
            ->join('users', 'users.id', '=', 'data_po.user_idbid')
            ->join('penerimaan_po', 'penerimaan_po.penerimaan_id_data_po', '=', 'data_po.id_data_po')
            ->where('penerimaan_po.tonase_akhir', '!=', NULL)
            ->where('penerimaan_po.analisa', 'revisi')
        ...
        $getcountnotif_antrianbongkar1 = DataPO::join('penerimaan_po', 'penerimaan_po.penerimaan_id_data_po', '=', 'data_po.id_data_po')
            ...
            ->count();
        $getcountnotif_antrianbongkar2 = DataPO::join('penerimaan_po', 'penerimaan_po.penerimaan_id_data_po', '=', 'data_po.id_data_po')
            ->join('lab1_pk', 'lab1_pk.lab1_id_data_po_pk', '=', 'data_po.id_data_po')
            ->where('lab1_pk.status_lab1_pk', '=', '7')
            ->count();
        $total_dataantrianbongkar = ($getcountnotif_antrianbongkar1 + $getcountnotif_antrianbongkar2);
        $getcountnotif_prosesbongkar1 = DataPO::join('bid', 'bid.id_bid', '=', 'data_po.bid_id')
            ...
            ->count();
        $getcountnotif_prosesbongkar2 = DataPO::join('users', 'users.id', '=', 'data_po.user_idbid')
            ->join('penerimaan_po', 'penerimaan_po.penerimaan_id_data_po', '=', 'data_po.id_data_po')
            ->join('admins', 'admins.id', '=', 'penerimaan_po.penerima_po')
            ->join('lab1_pk', 'lab1_pk.lab1_id_data_po_pk', '=', 'data_po.kode_po')
            ->where('lab1_pk.status_lab1_pk', '=', '9')
            ->count();
        $total_prosesbongkar = ($getcountnotif_prosesbongkar1 + $getcountnotif_prosesbongkar2);
        ...
        return response()->json([
            'get_notifdatapembelian' => $get_notifdatapembelian,
            'get_notifdatarevisiap' => $get_notifdatarevisiap,
            'get_notifrevisispvap' => $get_notifrevisispvap,
            'get_notifapprovespvap' => $get_notifapprovespvap,
            'getcountnotif_tonaseawal' => $getcountnotif_tonaseawal,
            'getcountnotif_datatonaseawal' => $getcountnotif_datatonaseawal,
            'get_tonaseakhir' => $get_tonaseakhir,
            'get_datatonaseakhir' => $get_datatonaseakhir,
            'get_revisitonase' => $get_revisitonase,
            'total_dataantrianbongkar' => $total_dataantrianbongkar,
            'total_prosesbongkar' => $total_prosesbongkar,
            'getcountnotif_databongkar' => $getcountnotif_databongkar,
            'getcountnotif_revisibongkar' => $getcountnotif_revisibongkar,
