...
class DataPendingLab1ExportExcel implements FromCollection, WithHeadings, WithEvents, WithTitle, WithCustomStartCell
{
    /**
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function (AfterSheet $event) {
                ...
                $event->sheet->setCellValue('P1', 'LAPORAN PENDING PEMBELIAN GABAH PT SURYA PANGAN SEMESTA NGAWI');
