...
class DataOnProsesLab2ExportExcel implements FromCollection, WithHeadings, WithEvents, WithTitle, WithCustomStartCell
{
    /**
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function (AfterSheet $event) {
                ...
                $event->sheet->setCellValue('T1', 'LAPORAN KUALITAS LAB 2 PEMBELIAN GABAH PT. SURYA PANGAN SEMESTA');
