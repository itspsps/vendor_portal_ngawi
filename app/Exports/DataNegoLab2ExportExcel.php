...
class DataNegoLab2ExportExcel implements FromCollection, WithHeadings, WithEvents, WithTitle, WithCustomStartCell
{
    /**
        ...
        return [
            AfterSheet::class    => function (AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->getStyle('AT4:AV' . $data1)
                    ...
                    ->getStartColor()
                    ->setARGB('CC0000');
                $event->sheet->getDelegate()->getStyle('BA4:BB' . $data1)
                    ->getFill()
                    ->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)
                    ->getStartColor()
                    ->setARGB('41C0DA');
                $event->sheet->getDelegate()->getStyle('BC4:BC' . $data1)
                    ...
                    ->getStartColor()
                    ->setARGB('FFEFF6');
                $event->sheet->getDelegate()->getStyle('BD4:BD' . $data1)
                    ->getFill()
                    ->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)
                    ->getStartColor()
                    ->setARGB('DEFBFF');
                $event->sheet->getDelegate()->getStyle('BE4:BH' . $data1)
                    ->getFill()
                    ->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)
                    ->getStartColor()
                    ->setARGB('FF9933');
