...
class DataDealLab2ExportExcel implements FromCollection, WithHeadings, WithEvents, WithTitle, WithCustomStartCell
{
    /**
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function (AfterSheet $event) {
                ...
                $event->sheet->setCellValue('T1', 'LAPORAN DATA DEAL LAB 2 PT. SURYA PANGAN SEMESTA NGAWI');
